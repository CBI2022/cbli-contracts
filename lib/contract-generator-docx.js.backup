import { Document, Packer, Paragraph, TextRun, Table, TableRow, TableCell, ImageRun, Header, AlignmentType, PageBreak, BorderStyle, WidthType, VerticalAlign } from 'docx';
import fs from 'fs';
...
const translations = {
  ...
  fr: {
    ...
    number: "numero",
    and_nie: "et numero NIE",
    with_address: "domicile",
    hereinafter: "denomme(e) ci-apres",
    the_buyer: "L'ACHETEUR",
    the_seller: "LE VENDEUR",
    and_other_part: "D'autre part",
    ...
    declare: "DECLARENT",
    declare_1: "Que la partie vendeuse est proprietaire et desireu(se) de vendre le bien immobilier suivant:",
    type_of_property: "TYPE DE PROPRIETE",
    located_in: "sise",
    registered_in: "inscrite au registre de la propriete de",
    property_nr: "avec numero de propriete",
    volume: "Tome",
    book: "Livre",
    folio: "folio",
    cadastral_ref: "avec numero de reference cadastrale",
    declare_2: "Que la partie acheteur est interessee par l'acquisition du bien decrit dans la declaration I.",
    declare_3: "Les deux parties, dans leur propre interet, reglementent le present contrat par les dispositions suivantes,",
    clauses: "CLAUSES",
    ...
    second_price: "Le prix de la propriete objet de la vente convenu par les deux parties est",
    plus_taxes: "PLUS LES TAXES CORRESPONDANTES.",
    furniture_included: "La propriete sera transmise avec les meubles et appareils presents dans la propriete.",
    furniture_not_included: "Les meubles ne sont pas inclus dans la vente.",
    furniture_partial: "Meubles inclus selon la liste d'inventaire separee.",
    amounts_paid: "Ces montants seront payes sous la forme, les conditions et les modalites suivantes:",
    reservation_paid: "a ete verse en tant que depot de reservation a la partie intermediaire COSTA BLANCA LUXURY INVESTMENTS SL le",
    through_transfer: "par virement bancaire.",
    arras_to_pay: "a verser en tant qu'arrhes a la partie VENDEUR par virement bancaire.",
    account: "Compte",
    bank: "Banque",
    beneficiary: "Beneficiaire",
    concept_arras: "Concept: Arrhes",
    transfer_effective: "Ce virement doit etre effectue sur le compte susmentonne le",
    or_before: "ou avant, ce document devenant entierement effectif.",
    ...
    remaining_payment: "par virement bancaire au compte du vendeur",
    concept_purchase: "Concept: Achat",
    at_signing: "a payer a la signature de l'acte public de vente devant le Notaire de",
    ...
    fifth_clause_1: "La livraison de la possession de la propriete a l'acheteur aura lieu lors de la signature de l'acte devant un notaire.",
    fifth_clause_2: "La partie acheteur paiera a partir de la date de remise de la possession de la propriete, toutes les depenses (electricite, eau, etc.) et taxes inhErentes a la propriete.",
    fifth_clause_3: "Toutes les depenses et taxes qui ont accumule inherentes a la propriete avant la livraison de la possession seront payees par la partie vendeur.",
    fifth_clause_4: "La partie vendeur declare expressement que tous les services d'habitation (electricite, eau, gaz, etc.) fonctionnent correctement et s'engage a maintenir et payer jusqu'a la livraison de la possession de la propriete.",
    fifth_clause_5: "L'IBI et l'ordure pour l'annee en cours seront payes proportionnellement par les deux parties.",
    ...
    res_owners: "sont proprietaires de la totalite de la propriete detaillee ci-dessous:",
    res_capacity: "Les parties se reconnaissent mutuellement dans la position qu'elles exercent respectivement avec la capacite juridique necessaire pour se lier par cet accord de contrat.",
    res_price_clause: "Le prix de vente de la propriete est",
    res_furniture_not: "meubles non inclus",
    res_excl_taxes: "(impots exclus).",
    ...
    res_concept: "Concept: Reservation Ref.",
    res_arras_commit: "Les deux parties s'engagent a signer un contrat de depot dans les",
    res_calendar_days: "jours civils a compter de la date de signature du present document par les deux parties, avec livraison dans les",
    res_working_days: "jours ouvres apres la signature dudit document, de",
    res_to_seller: "a la partie vendeuse",
    res_as_arras: "en tant qu'arrhes penitenciales, qui seront considerees comme faisant partie du paiement de la propriete. Le reste du prix sera verse au moment de l'execution de l'acte public et de la livraison de la possession.",
    res_max_date: "Dans le contrat de depot susmentonne, la date maximale pour la signature de l'acte, la livraison de la possession et le paiement complet du prix convenu sera fixee comme",
    res_transfer_free: "La propriete sera transferee libre de charges, de locations, de residents et de restrictions d'urbanisme. La propriete sera livree avec paiement des taxes, droits et depenses associes a jour, les Vendeurs etant les proprietaires enregistres en pleine propriete, sans limitations ou restrictions pour son transfert.",
    ...
    res_withdraw_market: "Une fois ce contrat signe par les deux parties, le vendeur sera oblige de retirer la propriete du marche et d'informer tout autre agent immobilier qui avait l'ordre de la vendre, procedant le cas echeant a l'elimination, la publicite ou l'intervention dans sa mediation, avec le retrait immediat de tout affiche publicitaire a vendre, tant la sienne que celle d'autres agents.",
    res_sole_purpose: "Les parties conviennent que cet Accord a pour seul objet de reserver la propriete et de la retirer temporairement du marche et ne constitue pas un contrat d'achat prive ni un depot penitentiel, qui seront, le cas echeant, reglementes dans le contrat de depot subsequent.",
    ...
    res_cbli_label: "COSTA BLANCA LUXURY INVESTMENTS SL",
    clause_1: "PREMIER", clause_2: "DEUXIEME", clause_3: "TROISIEME", clause_4: "QUATRIEME",
    clause_5: "CINQUIEME", clause_6: "SIXIEME", clause_7: "SEPTIEME", clause_8: "HUITIEME",
    clause_9: "NEUVIEME", clause_10: "DIXIEME",
  },
  de: {
    arras_title: "KAUTION (ARRAS)",
    reservation_title: "RESERVIERUNGSVEREINBARUNG",
    reunidos: "VERSAMMELT",
    on_one_part: "Einerseits",
    of_legal_age: "volljährig",
    of_nationality: "von Nationalität",
    with_valid: "mit gültig",
    number: "Nummer",
    and_nie: "und NIE-Nummer",
    with_address: "mit Adresse",
    hereinafter: "nachstehend genannt",
    the_buyer: "DER KÄUFER",
    the_seller: "DER VERKÄUFER",
    and_other_part: "Andererseits",
    ...
    declare: "ERKLÄREN",
    declare_1: "Dass die verkaufende Partei Eigentümer ist und an dem Verkauf der folgenden Immobilie interessiert ist:",
    type_of_property: "GRUNDSTÜCKSTYP",
    located_in: "gelegen in",
    registered_in: "eingetragen im Grundbuch von",
    property_nr: "mit Grundstücksnummer",
    volume: "Band",
    book: "Buch",
    folio: "Blatt",
    cadastral_ref: "mit Flurstücksreferenznummer",
    declare_2: "Dass die kaufende Partei an dem Erwerb der in Erklärung I beschriebenen Immobilie interessiert ist.",
    declare_3: "Beide Parteien regeln im Falle ihres eigenen Interesses diesen Vertrag nach den folgenden",
    clauses: "KLAUSELN",
    first_arras: "erklärt sich bereit zu verkaufen an",
    ...
    second_price: "Der von beiden Parteien vereinbarte Preis für die Immobilie beträgt",
    plus_taxes: "PLUS DIE ENTSPRECHENDEN STEUERN.",
    furniture_included: "Die Immobilie wird mit den Möbeln und Geräten, die sich in der Immobilie befinden, übertragen.",
    furniture_not_included: "Möbel sind nicht im Verkauf enthalten.",
    furniture_partial: "Möbel gemäß separater Inventarliste enthalten.",
    amounts_paid: "Diese Beträge werden wie folgt gezahlt:",
    reservation_paid: "als Reservierungskaution an die Vermittlungspartei COSTA BLANCA LUXURY INVESTMENTS SL am",
    through_transfer: "durch Banküberweisung.",
    arras_to_pay: "als Kaution an die VERKÄUFERPARTEI durch Banküberweisung zu zahlen.",
    account: "Konto",
    bank: "Bank",
    beneficiary: "Begünstigter",
    concept_arras: "Konzept: Kaution",
    transfer_effective: "Die Überweisung muss auf das genannte Konto am",
    or_before: "oder früher erfolgen, um vollständig wirksam zu werden in diesem Dokument.",
    ...
    remaining_payment: "durch Banküberweisung auf das Konto des Verkäufers",
    concept_purchase: "Konzept: Kauf",
    at_signing: "bei der Unterzeichnung der Urkunde vor dem Notar von",
    on_or_before: "am oder vor",
    third_clause: "Der Verkäufer verpflichtet sich nicht, die Immobilie, die Gegenstand dieses Vertrags ist, an einen Dritten abzutreten, zu belasten oder zu vermieten, bis die oben genannte Frist abläuft, für die Zahlung des Preises und die anschließende Formalisierung und Umwandlung in eine Urkunde.",
    fourth_clause: "Die kaufende Partei trägt die Kosten der Grunderwerbsteuer, Urkundensteuer, notariellen und Grundbuchgebühren, die sich aus der Ausstellung dieser Urkunde ergeben. Die verkaufende Partei zahlt die Kapitalertragssteuer (Plusvalia), wenn anwendbar.",
    fifth_clause_1: "Die Übergabe der Immobilie an den Käufer findet bei der Unterzeichnung der Urkunde vor einem Notar statt.",
    fifth_clause_2: "Die kaufende Partei zahlt ab dem Datum der Übergabe der Immobilie alle Kosten (Strom, Wasser usw.) und Steuern, die mit dem Eigentum verbunden sind.",
    fifth_clause_3: "Alle Kosten und Steuern, die mit dem Eigentum vor der Übergabe verbunden sind, werden von der verkaufenden Partei gezahlt.",
    fifth_clause_4: "Die verkaufende Partei erklärt ausdrücklich, dass alle Wohndienstleistungen (Strom, Wasser, Gas usw.) ordnungsgemäß funktionieren und verpflichtet sich zur Wartung und Zahlung bis zur Übergabe der Immobilie.",
    fifth_clause_5: "Die IBI und der Müll für das aktuelle Jahr werden proportional von beiden Parteien gezahlt.",
    sixth_clause: "Die Parteien verzichten ausdrücklich auf ihre eigenen Gesetzbücher und stimmen ausdrücklich zu, alle Rechtsstreitigkeiten, Unstimmigkeiten, Fragen oder Ansprüche, die sich aus der Ausführung oder Auslegung dieses Vertrags ergeben, der Gerichtsbarkeit und Behörde der Gerichte von Benidorm zu unterwerfen.",
    seventh_clause: "Im Falle von Meinungsverschiedenheiten oder Unstimmigkeiten zwischen den Parteien über die Auslegung dieses Vertrags wird die spanische Sprache oder Version der übersetzten Version vorgezogen.",
    closing: "Und zum Beweis der Einhaltung der oben genannten Vereinbarung unterzeichnen beide Parteien dieses Dokument oder per E-Mail zu einmaliger Wirkung, am angegebenen Ort und Datum oben.",
    ...
    res_owners: "sind Eigentümer der unten detailliert beschriebenen gesamten Immobilie:",
    res_capacity: "Die Parteien erkennen sich gegenseitig in der Position an, in der sie jeweils mit der erforderlichen Rechtsfähigkeit handeln, um sich an diese Vertragsvereinbarung zu binden.",
    res_price_clause: "Der Verkaufspreis der Immobilie beträgt",
    res_furniture_not: "Möbel nicht enthalten",
    res_excl_taxes: "(ohne Steuern).",
    res_buyers_shall: "Die Käufer zahlen diesen Betrag an die Verkäufer bei Ausführung der notariellen Verkaufsurkunde, abzüglich aller zuvor bezahlten Beträge wie nachstehend aufgeführt:",
    res_non_refundable: "das bei Unterzeichnung dieser Vereinbarung als NICHT RÜCKERSTATTBARE RESERVIERUNGSGEBÜHR gezahlt wird, muss auf den Namen von COSTA BLANCA LUXURY INVESTMENTS SL auf dem unten angegebenen Konto eingezahlt werden, und dieser Betrag bleibt bis zur Unterzeichnung des Depositverkaufs durch beide Parteien als Einzahlung bei dem genannten Unternehmen, zu welcher Zeit es auf das Konto des Verkäufers überwiesen wird:",
    res_concept: "Konzept: Reservierungsreferenz.",
    res_arras_commit: "Beide Parteien verpflichten sich, innerhalb von",
    res_calendar_days: "Kalendertagen ab dem Datum der Unterzeichnung dieses Dokuments durch beide Parteien einen Depositvertrag zu unterzeichnen, mit Lieferung innerhalb von",
    res_working_days: "Arbeitstagen nach Unterzeichnung des genannten Dokuments von",
    res_to_seller: "an die Verkäuferpartei",
    res_as_arras: "als Arras penitenciales, die als Teil der Immobilienzahlung betrachtet werden. Der Rest des Preises wird bei Ausführung der Urkunde und Übergabe des Besitzes gezahlt.",
    res_max_date: "In dem oben genannten Depositvertrag wird das Maximaldatum für die Unterzeichnung der Urkunde, die Übergabe des Besitzes und die vollständige Zahlung des vereinbarten Preises festgelegt als",
    res_transfer_free: "Die Immobilie wird ohne Lasten, Mietverträge, Bewohner und Stadtplanungsbeschränkungen übertragen. Die Immobilie wird mit bezahlten Steuern, Abgaben und verbundenen Kosten geliefert, wobei die Verkäufer die eingetragenen Eigentümer mit vollständigem Eigentumsrecht sind, ohne Beschränkungen oder Einschränkungen für die Übertragung.",
    res_cbli_role: "COSTA BLANCA LUXURY INVESTMENTS SL agiert in dieser Transaktion ausschließlich als Immobilienmakler und Inhaber des Reservierungsbetrags und haftet nicht für den rechtlichen, städtebaulichen oder technischen Status der Immobilie, deren Überprüfung den Parteien obliegt.",
    res_seller_fault: "Falls der Kauf ausschließlich nicht formalisiert werden kann, weil der Verkäufer dies zu verantworten hat, z.B. aufgrund von Rechtsunregelmäßigkeiten der Immobilie oder mangelhafter Dokumentation für die notarielle Verkaufsurkunde, hat der Käufer das Recht, ohne Strafgebühr oder finanzielle Verpflichtung vom Vertrag zurückzutreten.",
    res_seller_refund: "In diesem Fall muss der Verkäufer dem Käufer alle bis zu diesem Moment gezahlten Beträge auf dem Kaufpreis vollständig erstatten.",
    res_withdraw_market: "Nach Unterzeichnung dieses Vertrags durch beide Parteien muss der Verkäufer die Immobilie vom Markt nehmen und jeden anderen Immobilienmakler benachrichtigen, der den Auftrag zum Verkauf hatte, und gegebenenfalls alle Verkaufsschilder entfernen.",
    res_sole_purpose: "Die Parteien vereinbaren, dass diese Vereinbarung ausschließlich der Reservierung der Immobilie und ihrer vorübergehenden Entfernung vom Markt dient und keinen privaten Kaufvertrag oder Bußgeldeinzahlung darstellt, die ggf. in einem späteren Depositvertrag geregelt wird.",
    res_spanish_prevails: "Im Falle von Meinungsverschiedenheiten über die Auslegung dieses Vertrags hat die spanische Version Vorrang.",
    res_closing: "Zum Beweis der Einhaltung unterzeichnen beide Parteien dieses Dokument am angegebenen Ort und am angegebenen Datum in der Kopfzeile des Dokuments.",
    res_cbli_label: "COSTA BLANCA LUXURY INVESTMENTS SL",
    clause_1: "ERSTE", clause_2: "ZWEITE", clause_3: "DRITTE", clause_4: "VIERTE",
    clause_5: "FÜNFTE", clause_6: "SECHSTE", clause_7: "SIEBENTE", clause_8: "ACHTE",
    clause_9: "NEUNTE", clause_10: "ZEHNTE",
  },
  ru: {
    arras_title: "ДОГОВОР ЗАДАТКА (АРРА)",
    reservation_title: "СОГЛАШЕНИЕ О РЕЗЕРВИРОВАНИИ",
    reunidos: "СОБРАЛИСЬ",
    on_one_part: "С одной стороны",
    of_legal_age: "совершеннолетний",
    of_nationality: "гражданство",
    with_valid: "с действительным",
    number: "номер",
    and_nie: "и номер NIE",
    with_address: "с адресом",
    hereinafter: "далее именуемый",
    the_buyer: "ПОКУПАТЕЛЬ",
    the_seller: "ПРОДАВЕЦ",
    and_other_part: "С другой стороны",
    ...
    declare: "ЗАЯВЛЯЮТ",
    declare_1: "Что продающая сторона является собственником и заинтересована в продаже следующего имущества:",
    type_of_property: "ВИД ИМУЩЕСТВА",
    located_in: "расположено в",
    registered_in: "зарегистрировано в реестре собственности",
    property_nr: "с номером имущества",
    volume: "Том",
    book: "Книга",
    folio: "лист",
    cadastral_ref: "с номером кадастрового справочника",
    declare_2: "Что покупающая сторона заинтересована в приобретении имущества, описанного в декларации I.",
    declare_3: "Обе стороны в своих собственных интересах регулируют настоящий договор следующим образом",
    clauses: "ПУНКТЫ",
    first_arras: "согласился продать",
    who_agrees: "который согласен приобрести имущество, описанное в декларации I, уже известное покупающей стороне, в физическом, техническом, конструктивном, городском и юридическом состояниях, которые он заявляет, что знает и принимает, свободное от ипотек, обременений, залогов, арендаторов или жильцов со всеми правами и использованием, а также со всеми доходами и соответствующими налогами, уплаченными на сегодняшний день.",
    second_price: "Цена имущества, являющегося предметом продажи, согласованная обеими сторонами составляет",
    plus_taxes: "ПЛЮС СООТВЕТСТВУЮЩИЕ НАЛОГИ.",
    furniture_included: "Имущество будет передано с мебелью и техникой, присутствующими в имуществе.",
    furniture_not_included: "Мебель не включена в продажу.",
    furniture_partial: "Мебель включена согласно отдельному инвентарному списку.",
    amounts_paid: "Эти суммы будут выплачены в следующей форме, условиях и положениях:",
    reservation_paid: "было выплачено в качестве резервного взноса промежуточной стороне COSTA BLANCA LUXURY INVESTMENTS SL на",
    through_transfer: "путем банковского перевода.",
    arras_to_pay: "подлежит выплате в качестве задатка стороне ПРОДАВЦА посредством банковского перевода.",
    account: "Счет",
    bank: "Банк",
    beneficiary: "Бенефициар",
    concept_arras: "Концепция: Задаток",
    transfer_effective: "Такой перевод должен быть осуществлен на указанный счет на",
    or_before: "или раньше, став полностью действительным в соответствии с настоящим документом.",
    arras_penitenciales: "Вышеупомянутые суммы имеют характер арас пенитенциалес в соответствии со статьей 1.454 испанского гражданского кодекса. Если покупатель нарушит какое-либо положение договора, не явится на подписание нотариального акта или не выплатит согласованную цену, продажа будет расторгнута и выплаченный задаток будет потерян в пользу продавца. Если продавец нарушит какое-либо положение договора или не явится к совершению нотариального акта на согласованных условиях, покупатель может выбрать расторжение покупки, при этом продавец обязан выплатить двойную сумму задатка.",
    remaining_payment: "путем банковского перевода на счет продавца",
    concept_purchase: "Концепция: Покупка",
    at_signing: "подлежит выплате при подписании нотариального акта продажи перед Нотариусом",
    on_or_before: "на или раньше",
    third_clause: "Продавец обязуется не передавать, не обременять и не сдавать в аренду имущество, являющееся предметом настоящего договора, третьей стороне до истечения вышеупомянутого периода для выплаты цены и последующего оформления и преобразования в нотариальный акт.",
    fourth_clause: "Покупающая сторона будет нести расходы на налог на передачу имущества, налог на марки, нотариальные и реестровые сборы, вытекающие из совершения настоящего акта. Продающая сторона выплатит налог на прибыль от прироста капитала (Plusvalia), если применимо.",
    fifth_clause_1: "Передача имущества покупателю будет произведена при подписании акта перед нотариусом.",
    fifth_clause_2: "Покупающая сторона будет нести все расходы (электричество, вода и т.д.) и налоги, вытекающие из владения имуществом с даты его передачи.",
    fifth_clause_3: "Все расходы и налоги, которые накопились в связи с владением имуществом до его передачи, будут оплачены продающей стороной.",
    fifth_clause_4: "Продающая сторона прямо указывает, что все жилищные услуги (электричество, вода, газ и т.д.) работают надлежащим образом и обязуется нести расходы на их содержание до передачи имущества.",
    fifth_clause_5: "Налог на имущество и мусор за текущий год будут оплачены обеими сторонами пропорционально.",
    sixth_clause: "Стороны прямо отказываются от своих собственных кодексов законов и прямо согласны подчинить любые судебные разбирательства, разногласия, вопросы или претензии, вытекающие из исполнения или толкования настоящего договора, юрисдикции и власти судов Бенидорма.",
    seventh_clause: "В случае разногласий или расхождений между сторонами в толковании настоящего договора испанский язык или версия будет преобладать над переводной версией.",
    closing: "И в доказательство соответствия вышеизложенному обе стороны подписывают этот документ или по электронной почте в однократном действии в указанном выше месте и дате.",
    seller_label: "ПРОДАВЕЦ",
    buyer_label: "ПОКУПАТЕЛЬ",
    res_all_parties: "Все стороны действуют от своего имени и по праву, согласившись в этом акте подписать это соглашение о резервировании в отношении имущества, идентифицированного ниже.",
    res_owners: "являются собственниками всего имущества, подробно описанного ниже:",
    res_capacity: "Стороны признают друг друга в качестве сторон, действующих с необходимой правоспособностью для заключения этого договора.",
    res_price_clause: "Цена продажи имущества составляет",
    res_furniture_not: "мебель не включена",
    res_excl_taxes: "(без учета налогов).",
    res_buyers_shall: "Покупатели выплатят указанную сумму Продавцам в момент совершения нотариального акта продажи, вычтя из этой суммы любые ранее произведенные платежи, указанные ниже:",
    res_non_refundable: "что будет выплачено в качестве НЕВОЗВРАТНОГО СБОРА ЗА РЕЗЕРВИРОВАНИЕ при подписании данного Соглашения, будет выплачено на имя COSTA BLANCA LUXURY INVESTMENTS SL на счет, указанный ниже, и указанная сумма останется во владении вышеупомянутой компании до подписания договора задатка обеими сторонами, в какой момент он будет переведен на счет продавца:",
    res_concept: "Концепция: Резервирование Ссылка.",
    res_arras_commit: "Обе стороны обязуются подписать договор задатка в течение",
    res_calendar_days: "календарных дней с даты подписания данного документа обеими сторонами с доставкой в течение",
    res_working_days: "рабочих дней после подписания указанного документа от",
    res_to_seller: "продающей стороне",
    res_as_arras: "в качестве арас пенитенциалес, которые считаются частью платежа за имущество. Остаток цены будет выплачен в момент совершения нотариального акта и передачи владения.",
    res_max_date: "В вышеупомянутом договоре задатка максимальная дата для подписания акта, передачи владения и полной выплаты согласованной цены устанавливается как",
    res_transfer_free: "Имущество передается свободным от обременений, аренды, жильцов и ограничений городского плана. Имущество будет доставлено в день с уплатой налогов, сборов и связанных расходов, Продавцы будут зарегистрированными собственниками с полным юридическим правом без ограничений или ограничений для передачи.",
    res_cbli_role: "COSTA BLANCA LUXURY INVESTMENTS SL действует в этой сделке исключительно как агент по недвижимости и держатель суммы резервирования и не несет ответственность за правовой, городской или технический статус имущества, проверка которого является ответственностью сторон.",
    res_seller_fault: "В случае, когда покупка не может быть оформлена исключительно из-за причин, вменяемых Продавцу, таких как наличие правовых нарушений в отношении имущества или невозможность получения юридически необходимой документации для совершения нотариального акта продажи перед Нотариусом, Покупатель имеет право отказаться от сделки без каких-либо штрафов или финансовых обязательств.",
    res_seller_refund: "В этом случае Продавец обязан полностью возместить Покупателю все суммы, уплаченные до этого момента в счет цены покупки.",
    res_withdraw_market: "После подписания этого договора обеими сторонами продавец обязуется снять имущество с рынка и уведомить любого другого агента по недвижимости, который имел приказ о его продаже, и при необходимости удалить все рекламные объявления о продаже.",
    res_sole_purpose: "Стороны согласны, что это Соглашение имеет исключительную цель зарезервировать имущество и временно вывести его с рынка и не представляет собой частный договор купли-продажи или штрафной задаток, который, если применимо, регулируется в последующем договоре задатка.",
    res_spanish_prevails: "В случае разногласий по толкованию настоящего договора испанская версия преобладает.",
    res_closing: "И в доказательство соответствия обе стороны подписывают этот документ в месте и на дату, указанные в заголовке документа.",
    res_cbli_label: "COSTA BLANCA LUXURY INVESTMENTS SL",
    clause_1: "ПЕРВЫЙ", clause_2: "ВТОРОЙ", clause_3: "ТРЕТИЙ", clause_4: "ЧЕТВЕРТЫЙ",
    clause_5: "ПЯТЫЙ", clause_6: "ШЕСТОЙ", clause_7: "СЕДЬМОЙ", clause_8: "ВОСЬМОЙ",
    clause_9: "ДЕВЯТЫЙ", clause_10: "ДЕСЯТЫЙ",
  },
};

const NATIONALITY_TRANSLATIONS = {
  en: { española: "Spanish", inglesa: "British", italiana: "Italian", alemana: "German", francesa: "French", rusa: "Russian", holandesa: "Dutch", noruega: "Norwegian", belga: "Belgian", sueca: "Swedish", estadounidense: "American", canadiense: "Canadian", irlandesa: "Irish" },
  nl: { española: "Spaans", inglesa: "Brits", italiana: "Italiaans", alemana: "Duits", francesa: "Frans", rusa: "Russisch", holandesa: "Nederlands", noruega: "Noors", belga: "Belgisch", sueca: "Zweeds", estadounidense: "Amerikaans", canadiense: "Canadees", irlandesa: "Iers" },
  fr: { española: "espagnole", inglesa: "britannique", italiana: "italienne", alemana: "allemande", francesa: "française", rusa: "russe", holandesa: "néerlandaise", noruega: "norvégienne", belga: "belge", sueca: "suédoise", estadounidense: "américaine", canadiense: "canadienne", irlandesa: "irlandaise" },
  de: { española: "spanisch", inglesa: "britisch", italiana: "italienisch", alemana: "deutsch", francesa: "französisch", rusa: "russisch", holandesa: "niederländisch", noruega: "norwegisch", belga: "belgisch", sueca: "schwedisch", estadounidense: "amerikanisch", canadiense: "kanadisch", irlandesa: "irisch" },
  ru: { española: "ispanskaya", inglesa: "britanskaya", italiana: "italyanskaya", alemana: "nemetskaya", francesa: "frantsuzskaya", rusa: "russkaya", holandesa: "niderlandskaya", noruega: "norvezhskaya", belga: "belgiyskaya", sueca: "shvedskaya", estadounidense: "amerikanskaya", canadiense: "kanadskaya", irlandesa: "irlandskaya" },
};
...
export async function generateContractDocx(formData) {
  ...
  const t = isMultiLang ? langEntries[0].t : translations.en;
  ...
  // Helper to add bilingual paragraph
  const addBilingual = (esText, transTextOrFn, spacingAfter = 200) => {
    const runs = createBilingualRuns(esText, langEntries, transTextOrFn);
    paragraphs.push(new Paragraph({
      children: runs,
      spacing: { after: spacingAfter, line: 240, lineRule: 'auto' },
    }));
  };

  // Helper to add regular paragraph
  const addPara = (text, opts = {}) => {
    const { bold = false, italic = false, align = 'left', fontSize = 11, spacing = 200 } = opts;
    paragraphs.push(new Paragraph({
      text,
      bold,
      italic,
  ...
  // Title
  if (headerImage) {
    addImage(headerImage, { width: 500, height: 80, align: 'center' });
  }

  // Contract title
  const title = d.type === 'arras' ? t.arras_title : t.reservation_title;
  addPara(title, { bold: true, align: 'center', fontSize: 14, spacing: 300 });

  // Date and location
  addPara(`${formatDate(d.date, 'es')}, en ${v(d.city)}`, { align: 'center', spacing: 200 });

  // ===== HEADER =====
  addPara(t.reunidos.toUpperCase(), { bold: true, align: 'center', spacing: 200 });

  // Seller section
  const sellerTitle = d.seller?.title === 'Don' ? 'D.' : 'Dna.';
  const sellerName = v(d.seller?.name);
  addPara(`${t.on_one_part}, ${sellerTitle} ${sellerName}, ${t.of_legal_age}, ${t.of_nationality} ${translateNat(d.seller?.nationality, 'es')}, ${t.with_valid} ${v(d.seller?.idType)} ${t.number} ${v(d.seller?.idNumber)} ${t.and_nie} ${v(d.seller?.nie || '___')}, ${t.with_address} ${v(d.seller?.address)}, ${t.hereinafter} ${t.the_seller},`, { spacing: 200 });

  // Buyer section
  const buyerTitle = d.buyer?.title === 'Don' ? 'D.' : 'Dna.';
  const buyerName = v(d.buyer?.name);
  addPara(`${t.and_other_part}, ${buyerTitle} ${buyerName}, ${t.of_legal_age}, ${t.of_nationality} ${translateNat(d.buyer?.nationality, 'es')}, ${t.with_valid} ${v(d.buyer?.idType)} ${t.number} ${v(d.buyer?.idNumber)} ${t.and_nie} ${v(d.buyer?.nie || '___')}, ${t.with_address} ${v(d.buyer?.address)}, ${t.hereinafter} ${t.the_buyer},`, { spacing: 200 });

  addPara(t.both_parties_intro, { spacing: 200 });

  // DECLARATIONS
  addPara(t.declare.toUpperCase(), { bold: true, align: 'center', spacing: 200 });
  ...
  addBilingual(
    `${t.type_of_property}: ${propType}, ${t.located_in} ${v(d.property?.address)}, ${t.registered_in} ${v(d.property?.registry)}, ${t.property_nr} ${v(d.property?.finca)}, ${t.volume} ${v(d.property?.tomo)}, ${t.book} ${v(d.property?.libro)}, ${t.folio} ${v(d.property?.folio)}, ${t.cadastral_ref} ${v(d.property?.catastral)}.`,
    (trans, lang) => `${trans.type_of_property}: ${propType}, ${trans.located_in} ${v(d.property?.address)}, ${trans.registered_in} ${v(d.property?.registry)}, ${trans.property_nr} ${v(d.property?.finca)}, ${trans.volume} ${v(d.property?.tomo)}, ${trans.book} ${v(d.property?.libro)}, ${trans.folio} ${v(d.property?.folio)}, ${trans.cadastral_ref} ${v(d.property?.catastral)}.`,
    200
  );
  ...
  if (d.extraProperties && d.extraProperties.length > 0) {
    d.extraProperties.forEach((prop, idx) => {
      if (prop.enabled) {
        addBilingual(
          `${t.type_of_property} ${idx + 2}: ${v(prop.type)}, ${t.cadastral_ref} ${v(prop.catastral)}, ${t.property_nr} ${v(prop.finca)}, ${t.volume} ${v(prop.tomo)}, ${t.book} ${v(prop.libro)}, ${t.folio} ${v(prop.folio)}.`,
          (trans, lang) => `${trans.type_of_property} ${idx + 2}: ${v(prop.type)}, ${trans.cadastral_ref} ${v(prop.catastral)}, ${trans.property_nr} ${v(prop.finca)}, ${trans.volume} ${v(prop.tomo)}, ${trans.book} ${v(prop.libro)}, ${trans.folio} ${v(prop.folio)}.`,
          200
        );
      }
    });
  ...
  addBilingual(
    `III. ${t.declare_3}`,
    (trans, lang) => `III. ${trans.declare_3}`,
    200
  );

  // CLAUSES header
  addPara(t.clauses.toUpperCase(), { bold: true, underline: true, align: 'center', spacing: 100 });

  if (isMultiLang && langEntries) {
    langEntries.forEach((entry, idx) => {
      const color = LANG_COLORS[entry.lang] || '333333';
      addPara(entry.t.clauses, {
        bold: true, italic: true, align: 'center', spacing: 100
      });
    });
  }

  // Now add contract-specific content (ARRAS or RESERVATION)
  if (d.type === 'arras') {
    // ARRAS-specific clauses

    // PRIMERA - Sale commitment
    const sellerFullEs = d.seller?.hasPartner && d.seller?.partner?.name
      ? `${sellerTitle} ${sellerName} y ${d.seller.partner.title === 'Dona' ? 'Dna.' : 'D.'} ${v(d.seller.partner.name)} se comprometen a vender a ${buyerTitle} ${buyerName}${d.buyer?.hasPartner && d.buyer?.partner?.name ? ` y ${d.buyer.partner.title === 'Dona' ? 'Dna.' : 'D.'} ${v(d.buyer.partner.name)}` : ''}, quienes se comprometen a comprar, las fincas descritas en el expositivo I...`
      : `${sellerTitle} ${sellerName} se compromete a vender a ${buyerTitle} ${buyerName}${d.buyer?.hasPartner && d.buyer?.partner?.name ? ` y ${d.buyer.partner.title === 'Dona' ? 'Dna.' : 'D.'} ${v(d.buyer.partner.name)}` : ''}, quien(es) se compromete(n) a comprar, las fincas descritas en el expositivo I...`;

    addBilingual(
      `1. PRIMERA.- ${sellerFullEs}`,
      (trans, lang) => `1. ${trans.clause_1}.- ${sellerTitle} ${sellerName} ${trans.first_arras} ${buyerTitle} ${buyerName}, ${trans.who_agrees}`,
      200
    );

    // SEGUNDA - Price
    addBilingual(
      `2. SEGUNDA.- El precio de la finca objeto de la compraventa convenido por ambas partes es de ${formatMoney(d.price?.total)} MAS LOS CORRESPONDIENTES IMPUESTOS.`,
      (trans, lang) => `2. ${trans.clause_2}.- ${trans.second_price} ${formatMoney(d.price?.total, lang)} ${trans.plus_taxes}`,
      200
    );
    ...
    addBilingual(
      ...
      (trans, lang) => trans.amounts_paid,
      200
    );

    // Reservation payment
    addBilingual(
      `a) La cantidad de ${formatMoney(d.price?.reservation)} ha sido abonada en concepto de reserva a la parte intermediaria COSTA BLANCA LUXURY INVESTMENTS SL en fecha ${formatDate(d.price?.reservationDate, 'es')} mediante transferencia bancaria.`,
      (trans, lang) => `a) The amount of ${formatMoney(d.price?.reservation, lang)} ${trans.reservation_paid} ${formatDate(d.price?.reservationDate, lang)} ${trans.through_transfer}`,
      200
    );

    // Arras payment
    addBilingual(
      `b) La cantidad de ${formatMoney(d.price?.arras)} a abonar en concepto de arras a la parte VENDEDORA mediante transferencia bancaria.`,
      (trans, lang) => `b) The amount of ${formatMoney(d.price?.arras, lang)} ${trans.arras_to_pay}`,
      200
    );

    // Bank details (Spanish only)
    addPara(`IBAN: ${v(d.bank?.iban)}`, { bold: true, spacing: 100 });
    addPara(`Banco: ${v(d.bank?.bankName)}`, { spacing: 100 });
    addPara(`Beneficiario: ${v(d.bank?.beneficiary)}`, { spacing: 100 });
    addPara('Concepto: Arras', { bold: true, spacing: 200 });
    ...
    addBilingual(
      ...
      (trans, lang) => `${trans.transfer_effective} ${formatDate(d.price?.arrasDeadline, lang)} ${trans.or_before}`,
      200
    );

    // Arras penitenciales
    addBilingual(
      `Las referidas cantidades — ${formatMoney(d.price?.arras)} — tienen el concepto de arras penitenciales segun el articulo 1.454 del vigente codigo civil. Si el comprador incumpliera cualquiera de las clausulas pactadas en el presente documento, no compareciere en el acto de la firma de escritura publica o no pagara el precio pactado, la venta quedara resuelta y la senal perdida en favor del vendedor. Si fuera este ultimo el que incumpliera cualquiera de las clausulas previstas en el presente documento, o no compareciera al otorgamiento de la escritura publica en los terminos pactados, el comprador podra optar por resolver la compra, con obligacion del vendedor de pagar el importe doble de la senal.`,
      (trans, lang) => {
        const amount = formatMoney(d.price?.arras, lang);
        if (lang === 'en') return trans.arras_penitenciales.replace('The aforementioned amounts have', `The aforementioned amounts — ${amount} — have`);
        if (lang === 'nl') return trans.arras_penitenciales.replace('De voornoemde bedragen hebben', `De voornoemde bedragen — ${amount} — hebben`);
        if (lang === 'fr') return trans.arras_penitenciales.replace('Les montants susmentionnes ont', `Les montants susmentionnes — ${amount} — ont`);
        if (lang === 'de') return trans.arras_penitenciales.replace('Die oben erwahnten Betraege haben', `Die oben erwahnten Betraege — ${amount} — haben`);
        return trans.arras_penitenciales;
      },
      200
    );
    ...
    // Remaining payment
    addBilingual(
      `c) La cantidad de ${formatMoney(d.price?.remaining)} a pagar mediante transferencia bancaria a la cuenta bancaria de la parte vendedora a la firma de la escritura publica de compraventa ante el Notario de ${v(d.notaryLocation)} ${v(d.notary)}, que tendra lugar el mismo dia o antes del ${formatDate(d.price?.notaryDate, 'es')}.`,
      (trans, lang) => `c) The amount of ${formatMoney(d.price?.remaining, lang)} ${trans.remaining_payment}, ${trans.at_signing} ${v(d.notaryLocation)} ${v(d.notary)}, ${trans.on_or_before} ${formatDate(d.price?.notaryDate, lang)}.`,
      200
    );
    ...
    addPara(`Banco: ${v(d.bank?.bankName)}`, { spacing: 100 });
    addPara(`Beneficiario: ${v(d.bank?.beneficiary)}`, { spacing: 100 });
    addPara('Concepto: Compraventa', { bold: true, spacing: 200 });

    // TERCERA
    addBilingual(
      `3. TERCERA.- El vendedor se compromete a no ceder, gravar o arrendar la finca, objeto del presente contrato a un tercero, hasta el vencimiento del plazo citado anteriormente, para el pago del precio y la consiguiente formalizacion y elevacion a escritura publica.`,
      (trans, lang) => `3. ${trans.clause_3}.- ${trans.third_clause}`,
      200
    );

    // CUARTA
    addBilingual(
      `4. CUARTA.- La parte compradora hara frente al pago del impuesto de transmisiones patrimoniales, actos juridicos documentados e importes notariales y registrales que se deriven del otorgamiento de la presente escritura. La parte vendedora abonara el Impuesto Municipal sobre el Incremento del Valor de los Terrenos de Naturaleza Urbana (Plusvalia) si se devengara.`,
      (trans, lang) => `4. ${trans.clause_4}.- ${trans.fourth_clause}`,
      200
    );

    // QUINTA
    addBilingual(
      `5. QUINTA.- La entrega de la posesion de la finca a la compradora, tendra lugar en el acto de la firma de la escritura ante notario.`,
      (trans, lang) => `5. ${trans.clause_5}.- ${trans.fifth_clause_1}`,
      200
    );
    ...
    addBilingual(
      ...
      (trans, lang) => trans.fifth_clause_2,
      200
    );
    ...
    addBilingual(
      ...
      (trans, lang) => trans.fifth_clause_3,
      200
    );
    ...
    addBilingual(
      ...
      (trans, lang) => trans.fifth_clause_4,
      200
    );

    addBilingual(
      'El IBI y la basura correspondiente al ano en curso seran pagados proporcionalmente por ambas partes.',
      (trans, lang) => trans.fifth_clause_5,
      200
    );

    // SEXTA
    addBilingual(
      `6. SEXTA.- Las partes, con renuncia a cualquier otro fuero que pudiera corresponderles, se someten expresamente a la jurisdiccion y competencia de los Juzgados y Tribunales de Benidorm, para solventar cualquier litigio, discrepancia, cuestion o reclamacion resultantes de la ejecucion o interpretacion del presente Contrato.`,
      (trans, lang) => `6. ${trans.clause_6}.- ${trans.sixth_clause}`,
      200
    );

    // SEPTIMA
    addBilingual(
      `7. SEPTIMA.- En caso de discrepancia en la interpretacion del contenido del presente, prevalecera lo establecido en lengua espanola.`,
      (trans, lang) => `7. ${trans.clause_7}.- ${trans.seventh_clause}`,
      200
    );

    // Special conditions
    if (d.conditions && d.conditions !== '___') {
      addPara('8. OCTAVA.- CONDICIONES ESPECIALES / SPECIAL CONDITIONS', { bold: true, spacing: 200 });
      addPara(d.conditions, { spacing: 200 });
      if (isMultiLang && langEntries && d.translatedConditions) {
    ...
    addBilingual(
      t.res_all_parties,
      (trans, lang) => trans.res_all_parties,
      200
    );

    const owners = `${sellerTitle} ${sellerName}${d.seller?.hasPartner && d.seller?.partner?.name ? ` and ${d.seller.partner.title === 'Dona' ? 'Dna.' : 'D.'} ${v(d.seller.partner.name)}` : ''}, and ${buyerTitle} ${buyerName}${d.buyer?.hasPartner && d.buyer?.partner?.name ? ` and ${d.buyer.partner.title === 'Dona' ? 'Dna.' : 'D.'} ${v(d.buyer.partner.name)}` : ''}`;

    addBilingual(
      `${owners} ${t.res_owners}`,
      (trans, lang) => owners + ' ' + trans.res_owners,
      200
    );

    addBilingual(
      t.res_capacity,
      (trans, lang) => trans.res_capacity,
      200
    );

    addBilingual(
      `${t.res_price_clause} ${formatMoney(d.price?.total)} EUR, ${t.res_furniture_not}, ${t.res_excl_taxes}`,
      (trans, lang) => `${trans.res_price_clause} ${formatMoney(d.price?.total, lang)} EUR, ${trans.res_furniture_not}, ${trans.res_excl_taxes}`,
      200
    );

    addBilingual(
      t.res_buyers_shall,
      (trans, lang) => trans.res_buyers_shall,
      200
    );

    addBilingual(
      `a) ${formatMoney(d.price?.reservation)} ${t.res_non_refundable}`,
      (trans, lang) => `a) ${formatMoney(d.price?.reservation, lang)} ${trans.res_non_refundable}`,
      200
    );
    ...
    addPara(`Banco: ${v(d.bank?.bankName)}`, { spacing: 100 });
    addPara(`Beneficiario: ${v(d.bank?.beneficiary)}`, { spacing: 100 });
    addPara(`Concepto: Reserva Ref. ${formatDate(d.price?.reservationDate, 'es')}`, { bold: true, spacing: 200 });

    addBilingual(
      `${t.res_arras_commit} ${v(d.arrasSignDays)} ${t.res_calendar_days} ${t.res_working_days} ${formatMoney(d.price?.arras)} ${t.res_to_seller} ${t.res_as_arras}`,
      (trans, lang) => `${trans.res_arras_commit} ${v(d.arrasSignDays)} ${trans.res_calendar_days} ${trans.res_working_days} ${formatMoney(d.price?.arras, lang)} ${trans.res_to_seller} ${trans.res_as_arras}`,
      200
    );

    addBilingual(
      `${t.res_max_date} ${formatDate(d.price?.notaryDate, 'es')}.`,
      (trans, lang) => `${trans.res_max_date} ${formatDate(d.price?.notaryDate, lang)}.`,
      200
    );

    addBilingual(
      t.res_transfer_free,
      (trans, lang) => trans.res_transfer_free,
      200
    );

    addBilingual(
      t.res_cbli_role,
      (trans, lang) => trans.res_cbli_role,
      200
    );

    addBilingual(
      `7. SEPTIMA.- ${t.res_seller_fault}`,
    ...
    addBilingual(
      t.res_seller_refund,
      (trans, lang) => trans.res_seller_refund,
      200
    );

    addBilingual(
      `8. OCTAVA.- ${t.res_withdraw_market}`,
    ...
    addBilingual(
      t.res_sole_purpose,
      (trans, lang) => trans.res_sole_purpose,
      200
    );

    addBilingual(
      `9. NOVENA.- ${t.res_spanish_prevails}`,
    ...
    // Special conditions
    if (d.conditions && d.conditions !== '___') {
      addPara('10. DECIMA.- CONDICIONES ESPECIALES / SPECIAL CONDITIONS', { bold: true, spacing: 200 });
      addPara(d.conditions, { spacing: 200 });
      if (isMultiLang && langEntries && d.translatedConditions) {
        langEntries.forEach((entry) => {
          const tc = d.translatedConditions[entry.lang];
        ...
        children: [
          new TableCell({
            children: [new Paragraph({
              text: t.seller_label || 'VENDEDOR / SELLER',
          ...
          new TableCell({
            children: [new Paragraph({
              text: t.buyer_label || 'COMPRADOR / BUYER',
              alignment: AlignmentType.CENTER,
              bold: true,
            })],
            borders: {
  ...
  paragraphs.push(new Paragraph({
    text: t.res_cbli_label || 'COSTA BLANCA LUXURY INVESTMENTS SL',
    alignment: AlignmentType.CENTER,
    bold: true,
  }));
