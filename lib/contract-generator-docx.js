...
export async function generateContractDocx(formData) {
  ...
  if (d.type === 'commission') {
    // For commission: seller/buyer bilingual, CBLI Spanish only
    ...
    sigCol2Label = isMultiLang && sigTransLabel ? `COMPRADOR / ${sigTransLabel.buyer_label || 'BUYER'}` : 'COMPRADOR';
