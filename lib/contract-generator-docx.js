...
const translations = {
  es: {
    ...
    arras_to_pay: "a abonar en concepto de arras a la parte VENDEDORA mediante transferencia bancaria, OMF o cheque bancario.",
    account: "Cuenta",
    bank: "Banco",
  ...
  en: {
    ...
    arras_to_pay: "to be paid as arras deposit to the SELLER party through bank transfer, bank draft or bank cheque.",
    account: "Account",
    bank: "Bank",
