...
const translations = {
  es: {
    ...
    res_cbli_role: "COSTA BLANCA LUXURY INVESTMENTS SL actúa en la presente operación exclusivamente como intermediario inmobiliario y depositario del importe de reserva entregado por el Comprador.\nEn caso de no formalizarse la compraventa, la Agencia procederá a entregar o devolver las cantidades depositadas estrictamente conforme a lo establecido en el presente contrato y a las instrucciones acordadas entre las partes, sin asumir responsabilidad alguna sobre la decisión de las partes, el resultado de la operación o cualquier controversia derivada de la misma.\nAsimismo, la Agencia no será responsable del estado jurídico, urbanístico, técnico o administrativo del inmueble, cuya verificación y aceptación corresponde exclusivamente al Comprador y al Vendedor.",
  ...
  en: {
    ...
    res_cbli_role: "COSTA BLANCA LUXURY INVESTMENTS SL acts in this transaction exclusively as a real estate intermediary and holder of the reservation amount delivered by the Buyer.\nIn the event that the purchase is not formalized, the Agency shall proceed to deliver or refund the deposited amounts strictly in accordance with the terms of this contract and the instructions agreed between the parties, without assuming any responsibility for the parties' decisions, the outcome of the transaction or any controversy arising from it.\nLikewise, the Agency shall not be responsible for the legal, urban planning, technical or administrative status of the property, whose verification and acceptance corresponds exclusively to the Buyer and the Seller.",
