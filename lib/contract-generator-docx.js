...
export async function generateContractDocx(formData) {
  ...
  // Property details — form data in bold
  const propType = v(d.property?.type);
  addBilingual(
    [
      { text: `${esT.type_of_property}: ` }, { text: propType, bold: true },
      { text: `, ${esT.located_in} ` }, { text: v(d.property?.address), bold: true },
      { text: `, ${esT.registered_in} ` }, { text: v(d.property?.registry), bold: true },
      { text: `, ${esT.property_nr} ` }, { text: v(d.property?.finca), bold: true },
      { text: `, ${esT.volume} ` }, { text: v(d.property?.tomo), bold: true },
      { text: `, ${esT.book} ` }, { text: v(d.property?.libro), bold: true },
      { text: `, ${esT.folio} ` }, { text: v(d.property?.folio), bold: true },
      { text: `, ${esT.cadastral_ref} ` }, { text: v(d.property?.catastral), bold: true },
      { text: '.' },
    ],
    (trans, lang) => [
      { text: `${trans.type_of_property}: ` }, { text: propType, bold: true },
      { text: `, ${trans.located_in} ` }, { text: v(d.property?.address), bold: true },
      { text: `, ${trans.registered_in} ` }, { text: v(d.property?.registry), bold: true },
      { text: `, ${trans.property_nr} ` }, { text: v(d.property?.finca), bold: true },
      { text: `, ${trans.volume} ` }, { text: v(d.property?.tomo), bold: true },
      { text: `, ${trans.book} ` }, { text: v(d.property?.libro), bold: true },
      { text: `, ${trans.folio} ` }, { text: v(d.property?.folio), bold: true },
      { text: `, ${trans.cadastral_ref} ` }, { text: v(d.property?.catastral), bold: true },
      { text: '.' },
    ],
    200
  );

  // Extra properties — form data in bold
  if (d.extraProperties && d.extraProperties.length > 0) {
    d.extraProperties.forEach((prop, idx) => {
      if (prop.enabled) {
        addBilingual(
          [
            { text: `${esT.type_of_property} ${idx + 2}: ` }, { text: v(prop.type), bold: true },
            { text: `, ${esT.cadastral_ref} ` }, { text: v(prop.catastral), bold: true },
            { text: `, ${esT.property_nr} ` }, { text: v(prop.finca), bold: true },
            { text: `, ${esT.volume} ` }, { text: v(prop.tomo), bold: true },
            { text: `, ${esT.book} ` }, { text: v(prop.libro), bold: true },
            { text: `, ${esT.folio} ` }, { text: v(prop.folio), bold: true },
            { text: '.' },
          ],
          (trans, lang) => [
            { text: `${trans.type_of_property} ${idx + 2}: ` }, { text: v(prop.type), bold: true },
            { text: `, ${trans.cadastral_ref} ` }, { text: v(prop.catastral), bold: true },
            { text: `, ${trans.property_nr} ` }, { text: v(prop.finca), bold: true },
            { text: `, ${trans.volume} ` }, { text: v(prop.tomo), bold: true },
            { text: `, ${trans.book} ` }, { text: v(prop.libro), bold: true },
            { text: `, ${trans.folio} ` }, { text: v(prop.folio), bold: true },
            { text: '.' },
          ],
          200
        );
  ...
  if (d.type === 'arras') {
    ...
    addBilingual(
      [
        { text: `2. ${esT.clause_2}.- ${esT.second_price} ` }, { text: formatMoney(d.price?.total), bold: true },
        { text: ` ${esT.plus_taxes}` },
      ],
      (trans, lang) => [
        { text: `2. ${trans.clause_2}.- ${trans.second_price} ` }, { text: formatMoney(d.price?.total, lang), bold: true },
    ...
    addBilingual(
      [
        { text: 'a) La cantidad de ' }, { text: formatMoney(d.price?.reservation), bold: true },
        { text: ` ${esT.reservation_paid} ` }, { text: formatDate(d.price?.reservationDate, 'es'), bold: true },
        { text: ` ${esT.through_transfer}` },
      ],
      (trans, lang) => [
        { text: 'a) ' }, { text: formatMoney(d.price?.reservation, lang), bold: true },
    ...
    addBilingual(
      [
        { text: 'b) La cantidad de ' }, { text: formatMoney(d.price?.arras), bold: true },
        { text: ` ${esT.arras_to_pay}` },
      ],
      (trans, lang) => [
        { text: 'b) ' }, { text: formatMoney(d.price?.arras, lang), bold: true },
    ...
    addBilingual(
      [
        { text: 'c) La cantidad de ' }, { text: formatMoney(d.price?.remaining), bold: true },
      ...
      (trans, lang) => [
        { text: 'c) ' }, { text: formatMoney(d.price?.remaining, lang), bold: true },
    ...
    addBilingual(
      [{ text: sellerFull, bold: true }, { text: ` ${esT.res_owners}` }],
      (trans, lang) => [{ text: sellerFull, bold: true }, { text: ` ${trans.res_owners}` }],
      200
    );
    ...
    addBilingual(
      [
        { text: `2. ${esT.clause_2}.- ${esT.res_price_clause} ` }, { text: formatMoney(d.price?.total), bold: true },
        { text: `, ${esT.res_furniture_not}, ${esT.res_excl_taxes}` },
      ],
      (trans, lang) => [
        { text: `2. ${trans.clause_2}.- ${trans.res_price_clause} ` }, { text: formatMoney(d.price?.total, lang), bold: true },
    ...
    addBilingual(
      [
        { text: 'a) ' }, { text: formatMoney(d.price?.reservation), bold: true },
        { text: ` ${esT.res_non_refundable}` },
      ],
      (trans, lang) => [
        { text: 'a) ' }, { text: formatMoney(d.price?.reservation, lang), bold: true },
        { text: ` ${trans.res_non_refundable}` },
      ],
      200
    );
    ...
    addBilingual(
      [
        ...
        { text: ` ${esT.res_calendar_days} ${esT.res_working_days} ` }, { text: formatMoney(d.price?.arras), bold: true },
        { text: ` ${esT.res_to_seller} ${esT.res_as_arras}` },
      ],
      (trans, lang) => [
        { text: `3. ${trans.clause_3}.- ${trans.res_arras_commit} ` }, { text: v(d.arrasSignDays), bold: true },
        { text: ` ${trans.res_calendar_days} ${trans.res_working_days} ` }, { text: formatMoney(d.price?.arras, lang), bold: true },
