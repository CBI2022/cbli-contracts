...
const translations = {
  es: {
    ...
    and_partner: "y",
    both_parties_intro: "Ambas partes intervienen en su propio nombre y derecho, reconociéndose mutuamente capacidad suficiente para otorgar el presente contrato.",
    declare: "EXPONEN",
    ...
    declare_2: "Que la parte compradora está interesada en la adquisición del inmueble descrito que se identifica en el expositivo I.",
    declare_3: "Ambas partes en su propio interés, regulan el presente contrato mediante las siguientes clausulas.",
    clauses: "CLÁUSULAS",
    first_arras: "se compromete(n) a vender a",
    who_agrees: "quien(es) se compromete(n) a comprar, la finca descrita en el expositivo I, ya conocidas por la parte compradora, en el estado físico, técnico, constructivo, urbanístico y jurídico que declara conocer y aceptar, libre de hipotecas, cargas, gravámenes, arrendatarios u ocupantes y con todos los derechos y usos, así como con todos los recibos e impuestos correspondientes pagados al día.",
    ...
    furniture_included: "La finca descrita bajo 1. en el apartado expositivo primero, se transmitirán dotada de los muebles y electrodomésticos presentes en la propiedad, consultar el Anexo adjunto para una descripción detallada.",
    ...
    through_transfer: "mediante transferencia bancaria a la siguiente cuenta:",
    arras_to_pay: "a abonar en concepto de arras a la parte VENDEDORA mediante transferencia bancaria, OMF o cheque bancario a la siguiente cuenta:",
    account: "Cuenta",
    bank: "Banco",
    ...
    arras_penitenciales: "Las referidas cantidades tienen el concepto de arras penitenciales según el artículo 1.454 del vigente código civil. Si el comprador incumpliera cualquiera de las cláusulas pactadas en el presente documento, no compareciere en el acto de la firma de escritura pública o no pagara el precio pactado, la venta quedará resuelta y la señal perdida en favor del vendedor. Si el vendedor incumpliera cualquiera de las cláusulas previstas en el presente documento, o no compareciera al otorgamiento de la escritura pública en los términos pactados, el comprador podrá optar por resolver la compra, con obligación del vendedor de pagar el importe doble de la señal.",
    remaining_payment: "a pagar mediante transferencia bancaria, OMF o cheque bancario a la cuenta bancaria de la parte vendedora",
    ...
    res_all_parties: "Todas las partes intervienen en su propio nombre y derecho, acordando en este acto firmar este contrato de reserva respecto al inmueble que se identifica en el expositivo I.",
    ...
    res_calendar_days: "días naturales desde la fecha de firma del presente documento, con entrega en un plazo de",
    res_working_days: "3 días hábiles tras la firma del referido documento, de",
    ...
    res_cbli_role: "COSTA BLANCA LUXURY INVESTMENTS SL actúa exclusivamente como intermediario inmobiliario y mero depositario temporal de las cantidades entregadas por el Comprador, sin asumir responsabilidad legal, urbanística, técnica, financiera o administrativa alguna respecto de la operación o del inmueble.\nLa Agencia procederá a entregar, retener o devolver las cantidades depositadas estrictamente conforme a lo establecido en el presente contrato y/o a las instrucciones escritas de las partes, sin asumir responsabilidad alguna por decisiones, incumplimientos o controversias entre Comprador y Vendedor.\nEn caso de conflicto o instrucciones contradictorias, la Agencia podrá retener las cantidades depositadas hasta recibir acuerdo escrito entre las partes o resolución judicial firme, sin responsabilidad alguna para la Agencia, salvo dolo o negligencia grave.",
    res_seller_fault: "7. SÉPTIMA.- Las cantidades entregadas por el Comprador en virtud del presente contrato tienen carácter de reserva del inmueble.\nEn caso de que el Comprador decida desistir de la operación por cualquier motivo no imputable al Vendedor, perderá íntegramente las cantidades entregadas hasta ese momento, sin derecho a devolución.\nÚnicamente procederá la devolución íntegra de las cantidades entregadas en el supuesto de que la compraventa no pueda formalizarse por causas imputables al Vendedor, tales como la existencia de irregularidades legales o urbanísticas graves que afecten al inmueble, la imposibilidad de transmitir legalmente la propiedad o la imposibilidad de obtener la documentación necesaria para el otorgamiento de la escritura pública de compraventa ante Notario.\nEn dicho caso, el Vendedor deberá devolver al Comprador la totalidad de las cantidades entregadas hasta ese momento.",
    res_seller_refund: "",
    res_withdraw_market: "8. OCTAVA.- Una vez firmado el presente contrato por ambas partes, el Vendedor se obliga a retirar inmediatamente el inmueble del mercado, cesando cualquier acción de comercialización o promoción del mismo, así como a comunicar dicha retirada a cualquier Agencia Inmobiliaria o tercero que tuviera encomendada su venta.\nAsimismo, el Vendedor se compromete a retirar cualquier anuncio, publicación o cartel publicitario relacionado con la venta del inmueble, ya sea propio o de terceros.\nLas partes acuerdan expresamente que el presente contrato tiene como única finalidad la reserva temporal del inmueble y su retirada del mercado, no constituyendo en ningún caso un contrato privado de compraventa. En su caso, las condiciones definitivas de la compraventa se regularán posteriormente en el correspondiente contrato de arras o contrato privado de compraventa.",
  ...
  en: {
    ...
    and_partner: "and",
    both_parties_intro: "Both parties involved in their own name and right, recognizing with sufficient capacity to award this contract.",
    declare: "DECLARE",
    ...
    declare_2: "That the buying party is interested in the acquisition of the property identified in declaration I.",
    declare_3: "Both sides in their own interest, regulate the present agreement by using the following clauses.",
    clauses: "CLAUSES",
    ...
    furniture_included: "The property described under 1. in the first declaration section, shall be transmitted with the furniture and appliances present in the property, please refer to the attached Annex for a detailed description.",
    ...
    through_transfer: "through bank transfer to the following account:",
    arras_to_pay: "to be paid as arras deposit to the SELLER party through bank transfer, bank draft or bank cheque to the following account:",
    account: "Account",
    bank: "Bank",
    ...
    remaining_payment: "to be paid through bank transfer, bank draft or bank cheque to the account of the selling party",
    ...
    seller_label: "SELLER",
    buyer_label: "BUYER",
    res_all_parties: "All the parties intervene in their own name and right, agreeing in this act to sign this reservation agreement with respect to the property that is identified in the declaration I.",
    ...
    res_transfer_free: "The property shall be transfered free of charges, leases, occupants and urban planning encumbrances. The property shall be delivered up to date with the payment of taxes, duties and associated expenses, with the Sellers being the registered owners in full legal title, without limitations or restrictions for its transfer.",
    res_cbli_role: "COSTA BLANCA LUXURY INVESTMENTS SL acts exclusively as a real estate intermediary and mere temporary custodian of the amounts delivered by the Buyer, without assuming any legal, urban planning, technical, financial or administrative responsibility whatsoever with respect to the transaction or the property.\nThe Agency shall deliver, retain or return the deposited amounts strictly in accordance with the provisions of this contract and/or the written instructions of the parties, without assuming any responsibility for decisions, breaches or disputes between Buyer and Seller.\nIn the event of conflict or contradictory instructions, the Agency may retain the deposited amounts until receiving a written agreement between the parties or a final court ruling, without any liability for the Agency, except in cases of wilful misconduct or gross negligence.",
    res_seller_fault: "7. SEVENTH.- The amounts delivered by the Buyer under this contract have the character of reservation of the property.\nIf the Buyer decides to withdraw from the transaction for any reason not attributable to the Seller, the Buyer shall lose entirely the amounts delivered up to that moment, with no right to refund.\nOnly the full refund of the amounts delivered shall proceed in the event that the purchase cannot be formalized due to reasons attributable to the Seller, such as the existence of serious legal or urban planning irregularities affecting the property, the impossibility of legally transferring the property or the impossibility of obtaining the documentation necessary for the execution of the public deed of sale before a Notary.\nIn such case, the Seller shall refund to the Buyer all amounts delivered up to that moment.",
    res_seller_refund: "",
    res_withdraw_market: "8. EIGHTH.- Once this contract is signed by both parties, the Seller is obliged to immediately withdraw the property from the market, ceasing any action of marketing or promotion of it, and to communicate such withdrawal to any Real Estate Agency or third party who had the sale entrusted to them.\nLikewise, the Seller undertakes to withdraw any advertisement, publication or advertising poster related to the sale of the property, whether their own or those of third parties.\nThe parties expressly agree that this contract has the sole purpose of the temporary reservation of the property and its withdrawal from the market, not constituting in any case a private sales contract. If applicable, the final conditions of the sale shall be regulated subsequently in the corresponding deposit contract or private sales contract.",
    ...
    // Commission contract translations
    comm_on_one_hand: "On the one hand,",
    comm_and: "and",
    comm_of_nationality: "of nationality",
    comm_of_legal_age: "of legal age",
    comm_married: "married",
    comm_with: "with",
    comm_number: "number",
    comm_residing_at: "residing at",
    comm_hereinafter_seller: "Hereinafter the Seller.",
    comm_other_hand_company: "And on the other hand, the company",
    comm_with_cif: "with CIF",
    comm_with_address_at: "with address at",
    comm_on_behalf_of: "on behalf of Don",
    comm_has_offered: "That COSTA BLANCA LUXURY INVESTMENTS S.L. has offered and visited with the clients",
    comm_of_legal_age_with_nat: "of legal age, with nationality",
    comm_provided_with: "provided with",
    comm_following_property: "the following property of the Seller: URBAN:",
    comm_located_at: "located at",
    comm_registered_in: "registered in the",
    comm_property_registry: "Property Registry",
    comm_property_no: "property no.",
    comm_volume: "volume",
    comm_book: "book",
    comm_folio: "folio",
    comm_cadastral_ref: "with only cadastral reference:",
    comm_clients_want: "The clients mentioned above want to buy through the Real Estate agency",
    comm_property_described: "the property described in the previous section.",
    comm_agreed_price: "The agreed price for the sale of said home is",
    comm_agreed_commission: "The agreed commission of the intermediary is included in the sale price of a total of",
    comm_vat_total: "VAT = a total of",
    comm_first_payment: "Upon the payment of the 10% deposit as downpayment money into the seller's account, the seller will then pay a part of the total agreed commission, which amounts to",
    comm_second_payment: "The remaining commission, which amounts to",
    comm_paid_to: "will be paid to",
    comm_before_notary: "either before or on the same day as the signing at the agreed-upon notary.",
    comm_closing: "Both parties read this document, find it in accordance with their will, ratify its content, and sign it in duplicate, for a single purpose, at the aforementioned place and date.",
  },
  nl: {
    ...
    res_cbli_role: "COSTA BLANCA LUXURY INVESTMENTS SL treedt uitsluitend op als vastgoedtussenpersoon en louter tijdelijk bewaarder van de door de Koper betaalde bedragen, zonder enige juridische, stedenbouwkundige, technische, financiële of administratieve verantwoordelijkheid met betrekking tot de transactie of het onroerend goed.\nHet Agentschap zal de gedeponeerde bedragen uitsluitend afgeven, inhouden of terugbetalen overeenkomstig de bepalingen van dit contract en/of de schriftelijke instructies van de partijen, zonder enige verantwoordelijkheid voor beslissingen, tekortkomingen of geschillen tussen Koper en Verkoper.\nIn geval van conflict of tegenstrijdige instructies kan het Agentschap de gedeponeerde bedragen inhouden totdat een schriftelijke overeenkomst tussen de partijen of een definitieve rechterlijke uitspraak is ontvangen, zonder enige aansprakelijkheid voor het Agentschap, behoudens opzet of grove nalatigheid.",
    ...
    // Commission contract translations
    comm_on_one_hand: "Enerzijds,",
    comm_and: "en",
    comm_of_nationality: "van nationaliteit",
    comm_of_legal_age: "meerderjarig",
    comm_married: "getrouwd",
    comm_with: "met",
    comm_number: "nummer",
    comm_residing_at: "wonende te",
    comm_hereinafter_seller: "Hierna de Verkoper.",
    comm_other_hand_company: "En anderzijds de vennootschap",
    comm_with_cif: "met CIF",
    comm_with_address_at: "met adres te",
    comm_on_behalf_of: "vertegenwoordigd door de heer",
    comm_has_offered: "Dat COSTA BLANCA LUXURY INVESTMENTS S.L. heeft aangeboden en bezichtigd met de cliënt",
    comm_of_legal_age_with_nat: "meerderjarig, van nationaliteit",
    comm_provided_with: "voorzien van",
    comm_following_property: "het volgende eigendom van de Verkoper: STEDELIJK:",
    comm_located_at: "gelegen te",
    comm_registered_in: "ingeschreven in het",
    comm_property_registry: "Eigendomsregister",
    comm_property_no: "eigendomsnr.",
    comm_volume: "deel",
    comm_book: "boek",
    comm_folio: "folio",
    comm_cadastral_ref: "met enige kadastrale referentie:",
    comm_clients_want: "De bovengenoemde cliënten willen kopen via het vastgoedkantoor",
    comm_property_described: "het eigendom beschreven in het vorige artikel.",
    comm_agreed_price: "De overeengekomen prijs voor de verkoop van genoemde woning bedraagt",
    comm_agreed_commission: "De overeengekomen commissie van de tussenpersoon is inbegrepen in de verkoopprijs van in totaal",
    comm_vat_total: "BTW = een totaal van",
    comm_first_payment: "Bij de betaling van de 10% aanbetaling als waarborgsom op de rekening van de verkoper, zal de verkoper een deel van de totale overeengekomen commissie betalen, namelijk",
    comm_second_payment: "Het restant van de commissie, dat bedraagt",
    comm_paid_to: "zal worden betaald aan",
    comm_before_notary: "voor of op dezelfde dag als de ondertekening bij de overeengekomen notaris.",
    comm_closing: "Beide partijen lezen dit document, vinden het in overeenstemming met hun wil, bekrachtigen de inhoud, en ondertekenen het in tweevoud, met een enkel doel, op de eerdergenoemde plaats en datum.",
  },
  fr: {
    ...
    res_cbli_role: "COSTA BLANCA LUXURY INVESTMENTS SL agit exclusivement en tant qu'intermediaire immobilier et simple depositaire temporaire des sommes versees par l'Acheteur, sans assumer aucune responsabilite legale, urbanistique, technique, financiere ou administrative concernant l'operation ou le bien immobilier.\nL'Agence procedera a la remise, la retention ou la restitution des sommes deposees strictement conformement aux dispositions du present contrat et/ou aux instructions ecrites des parties, sans assumer aucune responsabilite pour les decisions, manquements ou litiges entre l'Acheteur et le Vendeur.\nEn cas de conflit ou d'instructions contradictoires, l'Agence pourra retenir les sommes deposees jusqu'a reception d'un accord ecrit entre les parties ou d'une decision judiciaire definitive, sans aucune responsabilite pour l'Agence, sauf en cas de faute intentionnelle ou de negligence grave.",
    ...
    // Commission contract translations
    comm_on_one_hand: "D'une part,",
    comm_and: "et",
    comm_of_nationality: "de nationalité",
    comm_of_legal_age: "majeur(e)",
    comm_married: "marié(e)",
    comm_with: "avec",
    comm_number: "numéro",
    comm_residing_at: "domicilié(e) à",
    comm_hereinafter_seller: "Ci-après le Vendeur.",
    comm_other_hand_company: "Et d'autre part la société",
    comm_with_cif: "avec CIF",
    comm_with_address_at: "ayant son siège à",
    comm_on_behalf_of: "représentée par Monsieur",
    comm_has_offered: "Que COSTA BLANCA LUXURY INVESTMENTS S.L. a proposé et visité avec le client",
    comm_of_legal_age_with_nat: "majeur(e), de nationalité",
    comm_provided_with: "muni(e) de",
    comm_following_property: "la propriété suivante du Vendeur: URBAINE:",
    comm_located_at: "située à",
    comm_registered_in: "inscrite au",
    comm_property_registry: "Registre de la Propriété",
    comm_property_no: "propriété nº",
    comm_volume: "tome",
    comm_book: "livre",
    comm_folio: "folio",
    comm_cadastral_ref: "avec référence cadastrale unique:",
    comm_clients_want: "Les clients susmentionnés souhaitent acheter par l'intermédiaire de l'agence immobilière",
    comm_property_described: "la propriété décrite dans la section précédente.",
    comm_agreed_price: "Le prix convenu pour la vente dudit logement est de",
    comm_agreed_commission: "La commission convenue de l'intermédiaire est incluse dans le prix de vente pour un total de",
    comm_vat_total: "TVA = un total de",
    comm_first_payment: "Lors du versement du dépôt de 10% en tant qu'arrhes sur le compte du vendeur, celui-ci versera une partie de la commission totale convenue, soit",
    comm_second_payment: "Le restant de la commission, qui s'élève à",
    comm_paid_to: "sera versé à",
    comm_before_notary: "avant ou le jour même de la signature chez le notaire convenu.",
    comm_closing: "Les deux parties lisent ce document, le trouvent conforme à leur volonté, ratifient son contenu et le signent en double exemplaire, à un seul effet, au lieu et date susmentionnés.",
  },
  de: {
    ...
    res_max_date: "In dem oben genannten Depositvertrag wird das Maximaldatum festgelegt als", res_transfer_free: "Die Immobilie wird ohne Lasten, Mietverträge, Bewohner und Stadtplanungsbeschränkungen übertragen. Die Immobilie wird mit bezahlten Steuern, Abgaben und zugehörigen Kosten übergeben, wobei die Verkäufer die eingetragenen Eigentümer mit vollem Eigentumsrecht sind, ohne Einschränkungen oder Beschränkungen für die Übertragung.", res_cbli_role: "COSTA BLANCA LUXURY INVESTMENTS SL handelt ausschließlich als Immobilienvermittler und bloßer vorübergehender Verwahrer der vom Käufer gezahlten Beträge, ohne jegliche rechtliche, städtebauliche, technische, finanzielle oder administrative Verantwortung in Bezug auf die Transaktion oder die Immobilie zu übernehmen.\nDie Agentur wird die hinterlegten Beträge ausschließlich gemäß den Bestimmungen dieses Vertrags und/oder den schriftlichen Anweisungen der Parteien aushändigen, einbehalten oder zurückerstatten, ohne jegliche Verantwortung für Entscheidungen, Vertragsverletzungen oder Streitigkeiten zwischen Käufer und Verkäufer.\nIm Falle eines Konflikts oder widersprüchlicher Anweisungen kann die Agentur die hinterlegten Beträge einbehalten, bis eine schriftliche Vereinbarung zwischen den Parteien oder ein rechtskräftiges Gerichtsurteil vorliegt, ohne jegliche Haftung der Agentur, außer bei Vorsatz oder grober Fahrlässigkeit.",
    ...
    // Commission contract translations
    comm_on_one_hand: "Einerseits,",
    comm_and: "und",
    comm_of_nationality: "von Nationalität",
    comm_of_legal_age: "volljährig",
    comm_married: "verheiratet",
    comm_with: "mit",
    comm_number: "Nummer",
    comm_residing_at: "wohnhaft in",
    comm_hereinafter_seller: "Im Folgenden der Verkäufer.",
    comm_other_hand_company: "Und andererseits die Gesellschaft",
    comm_with_cif: "mit CIF",
    comm_with_address_at: "mit Sitz in",
    comm_on_behalf_of: "vertreten durch Herrn",
    comm_has_offered: "Dass COSTA BLANCA LUXURY INVESTMENTS S.L. dem Kunden angeboten und besichtigt hat",
    comm_of_legal_age_with_nat: "volljährig, mit Nationalität",
    comm_provided_with: "ausgestattet mit",
    comm_following_property: "die folgende Immobilie des Verkäufers: STÄDTISCH:",
    comm_located_at: "gelegen in",
    comm_registered_in: "eingetragen im",
    comm_property_registry: "Grundbuch",
    comm_property_no: "Grundstücksnr.",
    comm_volume: "Band",
    comm_book: "Buch",
    comm_folio: "Blatt",
    comm_cadastral_ref: "mit einziger Katasterreferenz:",
    comm_clients_want: "Die oben genannten Kunden möchten über die Immobilienagentur kaufen",
    comm_property_described: "die im vorherigen Abschnitt beschriebene Immobilie.",
    comm_agreed_price: "Der vereinbarte Preis für den Verkauf der genannten Wohnung beträgt",
    comm_agreed_commission: "Die vereinbarte Provision des Vermittlers ist im Verkaufspreis enthalten in Höhe von insgesamt",
    comm_vat_total: "MwSt. = insgesamt",
    comm_first_payment: "Bei der Zahlung der 10% Anzahlung als Kaution auf das Konto des Verkäufers zahlt dieser einen Teil der vereinbarten Gesamtprovision, nämlich",
    comm_second_payment: "Der Rest der Provision, der sich beläuft auf",
    comm_paid_to: "wird gezahlt an",
    comm_before_notary: "vor oder am selben Tag der Unterzeichnung beim vereinbarten Notar.",
    comm_closing: "Beide Parteien lesen dieses Dokument, finden es im Einklang mit ihrem Willen, ratifizieren seinen Inhalt und unterzeichnen es in doppelter Ausfertigung am oben genannten Ort und Datum.",
  },
  ru: {
    ...
    res_max_date: "Максимальная дата устанавливается как", res_transfer_free: "Имущество передается свободным от обременений, аренды, жильцов и градостроительных ограничений. Имущество будет передано с оплаченными налогами, сборами и сопутствующими расходами, при этом Продавцы являются зарегистрированными собственниками с полным правом собственности, без ограничений для передачи.", res_cbli_role: "COSTA BLANCA LUXURY INVESTMENTS SL действует исключительно как посредник в сфере недвижимости и временный хранитель сумм, внесённых Покупателем, не принимая на себя никакой юридической, градостроительной, технической, финансовой или административной ответственности в отношении сделки или объекта недвижимости.\nАгентство передаст, удержит или вернёт депонированные суммы строго в соответствии с положениями настоящего договора и/или письменными указаниями сторон, не принимая на себя ответственности за решения, нарушения или споры между Покупателем и Продавцом.\nВ случае конфликта или противоречивых указаний Агентство вправе удержать депонированные суммы до получения письменного соглашения между сторонами или вступившего в силу судебного решения, без какой-либо ответственности Агентства, за исключением умысла или грубой халатности.",
    ...
    // Commission contract translations
    comm_on_one_hand: "С одной стороны,",
    comm_and: "и",
    comm_of_nationality: "гражданства",
    comm_of_legal_age: "совершеннолетний",
    comm_married: "в браке",
    comm_with: "с",
    comm_number: "номер",
    comm_residing_at: "проживающий по адресу",
    comm_hereinafter_seller: "Далее именуемый Продавец.",
    comm_other_hand_company: "И с другой стороны компания",
    comm_with_cif: "с CIF",
    comm_with_address_at: "с юридическим адресом",
    comm_on_behalf_of: "в лице г-на",
    comm_has_offered: "Что COSTA BLANCA LUXURY INVESTMENTS S.L. предложила и показала клиенту",
    comm_of_legal_age_with_nat: "совершеннолетний, гражданства",
    comm_provided_with: "с документом",
    comm_following_property: "следующую недвижимость Продавца: ЖИЛАЯ:",
    comm_located_at: "расположенную по адресу",
    comm_registered_in: "зарегистрированную в",
    comm_property_registry: "Реестре собственности",
    comm_property_no: "объект №",
    comm_volume: "том",
    comm_book: "книга",
    comm_folio: "лист",
    comm_cadastral_ref: "с единственной кадастральной ссылкой:",
    comm_clients_want: "Вышеупомянутые клиенты желают приобрести через агентство недвижимости",
    comm_property_described: "недвижимость, описанную в предыдущем разделе.",
    comm_agreed_price: "Согласованная цена продажи данного жилья составляет",
    comm_agreed_commission: "Согласованная комиссия посредника включена в цену продажи на общую сумму",
    comm_vat_total: "НДС = итого",
    comm_first_payment: "При внесении залога в размере 10% в качестве задатка на счёт продавца, продавец выплатит часть общей согласованной комиссии в размере",
    comm_second_payment: "Оставшаяся часть комиссии в размере",
    comm_paid_to: "будет выплачена",
    comm_before_notary: "до или в день подписания у согласованного нотариуса.",
    comm_closing: "Обе стороны прочитали этот документ, считают его соответствующим своей воле, подтверждают его содержание и подписывают в двух экземплярах в указанном месте и дату.",
  },
};
...
const _esFmtDocx = new Intl.NumberFormat('es-ES', { minimumFractionDigits: 2, maximumFractionDigits: 2, useGrouping: true });
...
function formatMoneyFull(amount, lang = 'es') {
  ...
  const absNum = Math.abs(num);
  const euros = Math.floor(absNum);
  const formatted = _esFmtDocx.format(absNum);
...
const CBLI_BANK = {
  iban: 'ES84 0081 1025 4100 0173 3079',
...
export async function generateContractDocx(formData) {
  ...
  // For reserva: always use CBLI Sabadell bank for the reservation deposit
  // For arras: use seller bank from form, fallback to CBLI
  // For commission: use commission bank from form
  const isReserva = d.type === 'reserva' || d.type === 'reservation';
  const bankIban = isReserva ? CBLI_BANK.iban : (d.bank?.iban?.trim() || CBLI_BANK.iban);
  const bankName = isReserva ? CBLI_BANK.bankName : (d.bank?.bankName?.trim() || CBLI_BANK.bankName);
  const bankBeneficiary = isReserva ? CBLI_BANK.beneficiary : (d.bank?.beneficiary?.trim() || CBLI_BANK.beneficiary);
  ...
  if (d.type === 'commission') {
    // Single-line title for commission — Spanish only, underlined, no translation
    paragraphs.push(new Paragraph({
      alignment: AlignmentType.CENTER,
      spacing: { after: 200, line: 240, lineRule: 'auto' },
      children: [new TextRun({ text: 'RECONOCIMIENTO DE HONORARIOS', bold: true, underline: {}, size: 28, color: BRAND.black, font: FONT })],
    }));
  } else {
    const titleEs = d.type === 'arras' ? esT.arras_title : esT.reservation_title;
    paragraphs.push(new Paragraph({
      alignment: AlignmentType.CENTER,
      spacing: { after: 200, line: 240, lineRule: 'auto' },
      children: [new TextRun({ text: titleEs, bold: true, size: 28, color: BRAND.black, underline: {}, font: FONT })],
    }));
  }

  // ========== REUNIDOS — black, bold, underlined, NOT translated (skip for commission) ==========
  if (d.type !== 'commission') {
  ...
  // Helper: fix Spanish nationality translations
  const fixNatEs = (nat) => {
    const n = (nat || '').toLowerCase();
    if (n === 'inglesa') return 'británica';
    if (n === 'holandesa') return 'neerlandesa';
    return nat || '___';
  };
  ...
  const personSegs = (title, name, nat, idType, idNumber, nie, address, label) => {
    const segs = [
      ...
      { text: `, mayor de edad, de nacionalidad ` }, { text: fixNatEs(nat), bold: true },
  ...
  // Each person listed with their own nationality + ID, then shared address + label
  const partnerSegs = (t1, n1, t2, n2, nat1, nat2, idT1, idN1, idT2, idN2, nie, address, label) => {
    const segs = [
      { text: `${t1} ` }, { text: n1, bold: true },
      { text: ', mayor de edad, de nacionalidad ' }, { text: fixNatEs(nat1), bold: true },
      { text: `, provisto de ${v(idT1)} vigente numero ` }, { text: v(idN1), bold: true },
      { text: ' y ' }, { text: `${t2} ` }, { text: n2, bold: true },
      { text: ', mayor de edad, de nacionalidad ' }, { text: fixNatEs(nat2), bold: true },
      { text: `, provista de ${v(idT2)} vigente número ` }, { text: v(idN2), bold: true },
      { text: ',' },
      { text: ` con domicilio a efectos de notificaciones ` }, { text: v(address), bold: true },
      { text: `, en adelante ${label}.` },
    ];
  ...
  // Shared helpers (used by all contract types)
  ...
  if (d.type !== 'commission') {
  // ── Standard seller/buyer/EXPONEN/CLAUSULAS (arras + reserva only) ──

  // Helper: translate Don/Doña to Mr./Mrs. etc.
  const trTitle = (title, lang) => {
    if (!lang || lang === 'es') return title;
    const isF = title === 'Dña.' || title === 'Doña' || title === 'Dona';
    if (lang === 'en') return isF ? 'Mrs.' : 'Mr.';
    if (lang === 'nl') return isF ? 'Mevr.' : 'Dhr.';
    if (lang === 'fr') return isF ? 'Mme' : 'M.';
    if (lang === 'de') return isF ? 'Frau' : 'Herr';
    if (lang === 'ru') return isF ? 'G-zha' : 'G-n';
    return title;
  };
  ...
  if (d.seller?.hasPartner && d.seller?.partner?.name) {
    ...
    addBilingual(
      ...
      (trans, lang) => [
        { text: `${trans.on_one_part}, ` },
        { text: `${trTitle(sellerTitle, lang)} `, }, { text: sellerName, bold: true },
        { text: `, ${trans.of_legal_age}, ${trans.of_nationality} ${translateNat(d.seller?.nationality, lang)}, ${trans.with_valid} ${v(d.seller?.idType)} ${trans.number} ` }, { text: v(d.seller?.idNumber), bold: true },
        { text: ` and ${trTitle(spTitle, lang)} ` }, { text: v(sp.name), bold: true },
        { text: `, ${trans.of_legal_age}, ${trans.of_nationality} ${translateNat(sp.nationality, lang)}, ${trans.with_valid} ${v(sp.idType)} ${trans.number} ` }, { text: v(sp.idNumber), bold: true },
        { text: `,${nieTr(d.seller?.nie, trans)} ${trans.with_address} ` }, { text: v(d.seller?.address), bold: true },
        { text: `, ${trans.hereinafter} ${trans.the_seller}.` },
      ],
      200
    );
  } else {
  ...
  if (d.buyer?.hasPartner && d.buyer?.partner?.name) {
    ...
    addBilingual(
      ...
      (trans, lang) => [
        { text: `${trans.and_other_part}, ` },
        { text: `${trTitle(buyerTitle, lang)} `, }, { text: buyerName, bold: true },
        { text: `, ${trans.of_legal_age}, ${trans.of_nationality} ${translateNat(d.buyer?.nationality, lang)}, ${trans.with_valid} ${v(d.buyer?.idType)} ${trans.number} ` }, { text: v(d.buyer?.idNumber), bold: true },
        { text: ` and ${trTitle(bpTitle, lang)} ` }, { text: v(bp.name), bold: true },
        { text: `, ${trans.of_legal_age}, ${trans.of_nationality} ${translateNat(bp.nationality, lang)}, ${trans.with_valid} ${v(bp.idType)} ${trans.number} ` }, { text: v(bp.idNumber), bold: true },
        { text: `,${nieTr(d.buyer?.nie, trans)} ${trans.with_address} ` }, { text: v(d.buyer?.address), bold: true },
        { text: `, ${trans.hereinafter} ${trans.the_buyer}.` },
      ],
      200
    );
  } else {
  ...
  if (d.type === 'arras') {
    ...
    // Reservation payment
    if (d.price?.reservation && parseFloat(d.price.reservation) > 0) {
      addBilingual(
        [
    ...
    addBilingual(
      [
        { text: 'a) La cantidad de ' }, { text: formatMoneyFull(d.price?.arras), bold: true },
        { text: ` ${esT.arras_to_pay}` },
      ],
      (trans, lang) => [
        { text: 'a) ' }, { text: formatMoneyFull(d.price?.arras, lang), bold: true },
    ...
    paragraphs.push(new Paragraph({
      indent: { left: 720 },
      spacing: { after: 80, line: 240, lineRule: 'auto' },
      children: [new TextRun({ text: 'SWIFT: ', font: FONT, size: FONT_SIZE }), new TextRun({ text: v(d.bank?.swift || ''), bold: true, font: FONT, size: FONT_SIZE })],
    }));
    addPara(`${esT.concept_arras}`, { spacing: 200, indent: 720 });
    ...
    addPara(`${esT.concept_purchase}`, { spacing: 200, indent: 720 });
    ...
    // Non-resident retention clause
    addBilingual(
      "En caso de que la parte vendedora sea no residente fiscal en España, en el acto de la firma de la escritura pública se practicará una retención del 3% sobre el precio de venta, conforme a lo establecido en la normativa fiscal vigente.",
      (trans, lang) => "In the event that the selling party is a non-fiscal resident in Spain, at the time of signing the public deed, a retention of 3% of the sale price will be applied, in accordance with current tax regulations.",
      200
    );
    ...
    // ========== COMMISSION AGREEMENT (RECONOCIMIENTO DE HONORARIOS) ==========
    // Follows the original template structure: COMPARECEN → DICEN Y OTORGAN

    // Helper to format IVA amount
    const fmtIVA = (net) => {
      const n = parseFloat(net) || 0;
      return _esFmtDocx.format(n) + '€';
    };
    const fmtIVATotal = (net) => {
      const n = parseFloat(net) || 0;
      const iva = n * 0.21;
      return _esFmtDocx.format(iva) + '€';
    };
    const fmtWithIVA = (net) => {
      const n = parseFloat(net) || 0;
      const total = n * 1.21;
      return _esFmtDocx.format(total) + '€';
    };

    // Discount
    const discount = parseFloat(d.commission?.discount) || 0;
    const commNet = parseFloat(d.commission?.totalCommission) || 0;
    const commAfterDiscount = commNet - discount;

    // Seller identification helpers
    const selHasPartner = d.seller?.hasPartner && d.seller?.partner?.name;
    const selTitle1 = d.seller?.title === 'Doña' || d.seller?.title === 'Dona' ? 'DOÑA' : 'DON';
    const selTitle2 = selHasPartner ? (d.seller.partner.title === 'Doña' || d.seller.partner.title === 'Dona' ? 'DOÑA' : 'DON') : '';
    const selIdType1 = v(d.seller?.idType);
    const selIdNum1 = v(d.seller?.idNumber);
    const selIdType2 = selHasPartner ? v(d.seller.partner.idType) : '';
    const selIdNum2 = selHasPartner ? v(d.seller.partner.idNumber) : '';

    // Buyer identification helpers
    const buyHasPartner = d.buyer?.hasPartner && d.buyer?.partner?.name;
    const buyTitle1 = d.buyer?.title === 'Doña' || d.buyer?.title === 'Dona' ? 'Doña' : 'Don';
    const buyTitle2 = buyHasPartner ? (d.buyer.partner.title === 'Doña' || d.buyer.partner.title === 'Dona' ? 'Doña' : 'Don') : '';

    // ── COMPARECEN ──
    addPara('COMPARECEN', { bold: true, align: 'center', spacing: 200, color: BRAND.black, fontSize: 24, underline: true });

    // Seller paragraph (ES) — each person listed with individual details
    const sellerSegsEs = [
      { text: 'De una parte, ' },
      { text: `${selTitle1} ${v(sellerName)}`, bold: true },
      { text: ', mayor de edad, de nacionalidad ' }, { text: fixNatEs(d.seller?.nationality), bold: true },
      { text: `, provisto de ${selIdType1} vigente numero ` }, { text: selIdNum1, bold: true },
    ];
    if (selHasPartner) {
      sellerSegsEs.push(
        { text: ' y ' }, { text: `${selTitle2} ${v(d.seller.partner.name)}`, bold: true },
        { text: ', mayor de edad, de nacionalidad ' }, { text: fixNatEs(d.seller.partner.nationality || d.seller?.nationality), bold: true },
        { text: `, provista de ${selIdType2} vigente número ` }, { text: selIdNum2, bold: true },
      );
    }
    sellerSegsEs.push(
      { text: ', con domicilio a efectos de notificaciones ' }, { text: v(d.seller?.address), bold: true },
      { text: `, en adelante ` }, { text: selHasPartner ? 'LOS VENDEDORES.' : 'el Vendedor.', bold: true },
    );
    addBilingual(sellerSegsEs, (trans, lang) => {
      const mrs = (d.seller?.title === 'Doña' || d.seller?.title === 'Dona') ? 'Mrs.' : 'Mr.';
      const natTranslated = NATIONALITY_TRANSLATIONS[lang]?.[v(d.seller?.nationality).toLowerCase()] || v(d.seller?.nationality);
      const segs = [
        { text: `${trans.comm_on_one_hand} ` },
        { text: `${mrs} ${v(sellerName)}`, bold: true },
        { text: `, ${trans.comm_of_legal_age}, ${trans.comm_of_nationality} ${natTranslated}, ${trans.comm_with} ${selIdType1} ${trans.comm_number} ` },
        { text: selIdNum1, bold: true },
      ];
      if (selHasPartner) {
        const mrs2 = (d.seller.partner.title === 'Doña' || d.seller.partner.title === 'Dona') ? 'Mrs.' : 'Mr.';
        const nat2 = NATIONALITY_TRANSLATIONS[lang]?.[(d.seller.partner.nationality || d.seller?.nationality || '').toLowerCase()] || d.seller.partner.nationality || v(d.seller?.nationality);
        segs.push(
          { text: ` ${trans.comm_and} ` },
          { text: `${mrs2} ${v(d.seller.partner.name)}`, bold: true },
          { text: `, ${trans.comm_of_legal_age}, ${trans.comm_of_nationality} ${nat2}, ${trans.comm_with} ${selIdType2} ${trans.comm_number} ` },
          { text: selIdNum2, bold: true },
        );
      }
      segs.push(
        { text: `, ${trans.comm_residing_at} ` }, { text: v(d.seller?.address), bold: true },
        { text: `. ${trans.comm_hereinafter_seller}` },
      );
      return segs;
    }, 200);

    // CBLI paragraph (ES) + translation
    addBilingual(
      [
        { text: 'Y de otra parte la mercantil ' },
        { text: 'COSTA BLANCA LUXURY INVESTMENTS S.L.', bold: true },
        { text: ' con CIF ' }, { text: 'B56281082', bold: true },
        { text: ', con domicilio en Puerto Deportivo Campomanes 59, 03590, Altea, Alicante en representación de Don ' },
        { text: 'BRUNO FELIPE', bold: true }, { text: '.' },
      ],
      (trans, lang) => `${trans.comm_other_hand_company} COSTA BLANCA LUXURY INVESTMENTS S.L. ${trans.comm_with_cif} B56281082, ${trans.comm_with_address_at} Puerto Deportivo Campomanes 59, 03590, Altea, Alicante ${trans.comm_on_behalf_of} BRUNO FELIPE.`,
      200
    );
    ...
    // CBLI visited property with buyer (ES) — buyer details embedded
    const dicenSegsEs = [
      { text: 'Que ' }, { text: 'COSTA BLANCA LUXURY INVESTMENTS S.L.', bold: true },
      { text: ' ha ofrecido y visitado con los clientes ' },
      { text: `${buyTitle1} ${v(buyerName)}`, bold: true },
      { text: `, mayor de edad, con nacionalidad ` }, { text: v(d.buyer?.nationality), bold: true },
      { text: `, provista de número de ${v(d.buyer?.idType)}: ` }, { text: v(d.buyer?.idNumber), bold: true },
    ];
    if (buyHasPartner) {
      dicenSegsEs.push(
        { text: `, y ${buyTitle2} ` }, { text: v(d.buyer.partner.name), bold: true },
        { text: `, mayor de edad, con nacionalidad ` }, { text: v(d.buyer?.partner?.nationality || d.buyer?.nationality), bold: true },
        { text: `, provista de número de ${v(d.buyer.partner.idType)}: ` }, { text: v(d.buyer.partner.idNumber), bold: true },
      );
    }
    dicenSegsEs.push(
      { text: ' la siguiente propiedad de la parte Vendedora: URBANA: ' },
      { text: v(d.property?.type), bold: true },
      { text: ', ubicada en ' }, { text: v(d.property?.address), bold: true },
    );
    if (hasVal(d.property?.registry)) dicenSegsEs.push({ text: ' registrada en el Registro de la Propiedad de ' }, { text: d.property.registry.trim(), bold: true });
    if (hasVal(d.property?.finca)) dicenSegsEs.push({ text: ', finca nº ' }, { text: d.property.finca.trim(), bold: true });
    if (hasVal(d.property?.tomo)) dicenSegsEs.push({ text: ', tomo ' }, { text: d.property.tomo.trim(), bold: true });
    if (hasVal(d.property?.libro)) dicenSegsEs.push({ text: ', libro ' }, { text: d.property.libro.trim(), bold: true });
    if (hasVal(d.property?.folio)) dicenSegsEs.push({ text: ', folio ' }, { text: d.property.folio.trim(), bold: true });
    if (hasVal(d.property?.catastral)) dicenSegsEs.push({ text: ', con única referencia catastral: ' }, { text: d.property.catastral.trim(), bold: true });
    dicenSegsEs.push({ text: '.' });

    addBilingual(dicenSegsEs, (trans, lang) => {
      const buyNatTranslated = NATIONALITY_TRANSLATIONS[lang]?.[v(d.buyer?.nationality).toLowerCase()] || v(d.buyer?.nationality);
      let text = `${trans.comm_has_offered} ${buyTitle1} ${v(buyerName)}, ${trans.comm_of_legal_age_with_nat} ${buyNatTranslated}, ${trans.comm_provided_with} ${v(d.buyer?.idType)} ${trans.comm_number}: ${v(d.buyer?.idNumber)}`;
      if (buyHasPartner) {
        const buyPartNat = NATIONALITY_TRANSLATIONS[lang]?.[v(d.buyer?.partner?.nationality || d.buyer?.nationality).toLowerCase()] || v(d.buyer?.partner?.nationality || d.buyer?.nationality);
        text += `, ${trans.comm_and} ${buyTitle2} ${v(d.buyer.partner.name)}, ${trans.comm_of_legal_age_with_nat} ${buyPartNat}, ${trans.comm_provided_with} ${v(d.buyer.partner.idType)} ${trans.comm_number}: ${v(d.buyer.partner.idNumber)}`;
      }
      text += `, ${trans.comm_following_property} ${v(d.property?.type)}, ${trans.comm_located_at} ${v(d.property?.address)}`;
      if (hasVal(d.property?.registry)) text += ` ${trans.comm_registered_in} ${d.property.registry.trim()} ${trans.comm_property_registry}`;
      if (hasVal(d.property?.finca)) text += `, ${trans.comm_property_no} ${d.property.finca.trim()}`;
      if (hasVal(d.property?.tomo)) text += `, ${trans.comm_volume} ${d.property.tomo.trim()}`;
      if (hasVal(d.property?.libro)) text += `, ${trans.comm_book} ${d.property.libro.trim()}`;
      if (hasVal(d.property?.folio)) text += `, ${trans.comm_folio} ${d.property.folio.trim()}`;
      if (hasVal(d.property?.catastral)) text += `, ${trans.comm_cadastral_ref} ${d.property.catastral.trim()}`;
      text += '.';
      return text;
    }, 200);

    // Clients want to buy through CBLI
    addBilingual(
      [
        { text: 'Los clientes arriba mencionados quieren comprar por mediación de la agencia Inmobiliaria ' },
        { text: 'COSTA BLANCA LUXURY INVESTMENTS S.L.', bold: true },
        { text: ' la propiedad descrita en el apartado anterior.' },
      ],
      (trans, lang) => [
        { text: `${trans.comm_clients_want} ` },
        { text: 'COSTA BLANCA LUXURY INVESTMENTS S.L.', bold: true },
        { text: ` ${trans.comm_property_described}` },
      ],
      200
    );

    // Price + commission paragraph
    addBilingual(
      [
        { text: 'El precio pactado para la venta de dicha vivienda es de ' },
        { text: formatMoneyFull(d.price?.total), bold: true },
        { text: '. La comisión pactada del intermediario está incluida en el precio de venta de un total de ' },
        { text: formatMoneyFull(commAfterDiscount > 0 ? String(commAfterDiscount) : d.commission?.totalCommission), bold: true },
        { text: ' + 21% ' }, { text: 'IVA', bold: true },
        { text: '= un total de ' },
        { text: formatMoneyFull(String(commAfterDiscount > 0 ? commAfterDiscount * 1.21 : (commNet * 1.21))), bold: true },
        { text: '.' },
      ],
      (trans, lang) => [
        { text: `${trans.comm_agreed_price} ` },
        { text: formatMoneyFull(d.price?.total, lang), bold: true },
        { text: `. ${trans.comm_agreed_commission} ` },
        { text: formatMoneyFull(commAfterDiscount > 0 ? String(commAfterDiscount) : d.commission?.totalCommission, lang), bold: true },
        { text: ` + 21% ${trans.comm_vat_total} ` },
        { text: formatMoneyFull(String(commAfterDiscount > 0 ? commAfterDiscount * 1.21 : (commNet * 1.21)), lang), bold: true },
        { text: '.' },
      ],
      200
    );

    // First payment at arras — only show if first payment > 0
    const fp = parseFloat(d.commission?.firstPayment) || 0;
    if (fp > 0) {
      const fpIVA = fp * 1.21;
      addBilingual(
        [
          { text: 'Al abonarse el depósito del 10% en concepto de arras en la cuenta del vendedor, este abonará un parte del total de la comisión pactada, que sería ' },
          { text: formatMoneyFull(d.commission?.firstPayment), bold: true },
          { text: ' + 21% IVA = un total de ' },
          { text: formatMoneyFull(String(fpIVA)), bold: true },
          { text: '.' },
        ],
        (trans, lang) => [
          { text: `${trans.comm_first_payment} ` },
          { text: formatMoneyFull(d.commission?.firstPayment, lang), bold: true },
          { text: ` + 21% ${trans.comm_vat_total} ` },
          { text: formatMoneyFull(String(fpIVA), lang), bold: true },
          { text: '.' },
        ],
        200
      );
    ...
    // Second payment at notary
    const sp = parseFloat(d.commission?.secondPayment) || 0;
    const spIVA = sp * 1.21;
    addBilingual(
      [
        { text: 'El restante de la comisión total que asciende a ' },
        { text: formatMoneyFull(d.commission?.secondPayment), bold: true },
        { text: ' + 21% IVA = un total de ' },
        { text: formatMoneyFull(String(spIVA)), bold: true },
        { text: ' será pagada a la inmobiliaria ' },
        { text: 'COSTA BLANCA LUXURY INVESTMENTS SL', bold: true },
        { text: ' antes o el mismo dia de la firma en la notaría acordada.' },
      ],
      (trans, lang) => [
        { text: `${trans.comm_second_payment} ` },
        { text: formatMoneyFull(d.commission?.secondPayment, lang), bold: true },
        { text: ` + 21% ${trans.comm_vat_total} ` },
        { text: formatMoneyFull(String(spIVA), lang), bold: true },
        { text: `, ${trans.comm_paid_to} ` },
        { text: 'COSTA BLANCA LUXURY INVESTMENTS SL', bold: true },
        { text: ` ${trans.comm_before_notary}` },
      ],
      200
    );

    // Bank details — hardcoded CBLI commission bank, bold, Spanish only
    addPara('Cuenta: ES29 3045 2650 8810 2101 3669', { bold: true, spacing: 80 });
    addPara('SWIFT: CCRIES2A045', { bold: true, spacing: 80 });
    addPara('Banco: CAIXA RURAL DE ALTEA', { bold: true, spacing: 80 });
    addPara('Beneficiario: COSTA BLANCA LUXURY INVESTMENTS SL', { bold: true, spacing: 80 });
    addPara('Concepto: Comision', { bold: true, spacing: 200 });

    // Closing
    addBilingual(
      'Ambas partes leen este documento, lo encuentran acorde con su voluntad, ratifican su contenido, lo firman por duplicado, a un solo efecto, en el lugar y fecha antedicha.',
      (trans, lang) => trans.comm_closing,
      300
    );
    ...
    addBilingual(
      [
        ...
        { text: `, ${esT.res_excl_taxes}, ${esT.res_furniture_not}.` },
      ],
      (trans, lang) => [
        { text: `2. ${trans.clause_2}.- ${trans.res_price_clause} ` }, { text: formatMoneyFull(d.price?.total, lang), bold: true },
        { text: `, ${trans.res_excl_taxes}, ${trans.res_furniture_not}.` },
      ],
      200
    );
    ...
    addPara(`${esT.res_concept} ${v(d.property?.ref)}`, { spacing: 200 });
    ...
    addBilingual(
      esT.res_seller_fault,
      (trans, lang) => trans.res_seller_fault,
      200
    );

    addBilingual(
      esT.res_withdraw_market,
      (trans, lang) => trans.res_withdraw_market,
      200
    );
  ...
  if (d.type === 'commission') {
    // For commission: seller + CBLI only (no buyer signature)
    const sigTransLabel = isMultiLang ? langEntries[0].t : null;
    sigCol1Label = isMultiLang && sigTransLabel ? `VENDEDOR / ${sigTransLabel.seller_label || 'SELLER'}` : 'VENDEDOR';
    sigCol1PartnerName = d.seller?.hasPartner && d.seller?.partner?.name ? v(d.seller.partner.name) : null;
    sigCol2Label = null; // no buyer for commission
    sigCol2PartnerName = null;
  ...
  const hasBuyerSig = sigCol2Label !== null;
  const sigColWidths = hasBuyerSig ? [3008, 3009, 3009] : [4513, 4513];
  ...
  const sigTable = new Table({
    ...
    rows: [
      ...
      new TableRow({
        children: [
          new TableCell({
            width: { size: sigColWidths[0], type: WidthType.DXA },
            borders: noBorders,
            margins: cellMargins,
          ...
          ...(hasBuyerSig ? [new TableCell({
            width: { size: sigColWidths[1], type: WidthType.DXA },
            borders: noBorders,
            margins: cellMargins,
            children: [new Paragraph({
              alignment: AlignmentType.CENTER,
          ...
          new TableCell({
            width: { size: sigColWidths[hasBuyerSig ? 2 : 1], type: WidthType.DXA },
            borders: noBorders,
            margins: cellMargins,
            children: [new Paragraph({
              alignment: AlignmentType.CENTER,
