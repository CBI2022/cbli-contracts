      ...
      <main style={S.main}>
        ...
        {((form.type==="ficha"&&step===5)||(form.type!=="ficha"&&step===6))&&<>
          ...
          {form.type==="ficha"&&<Card title="Send To">
            ...
            <Grid>
              <F label="Your name" path="ficha.agentEmailName" options={[{value:"",label:"Select your name..."},{value:"karina",label:"Karina"},{value:"timmy",label:"Timmy"},{value:"sofia",label:"Sofia"},{value:"dajana",label:"Dajana"},{value:"alejandro",label:"Alejandro"},{value:"doris",label:"Doris"},{value:"natalia",label:"Natalia"},{value:"oleg",label:"Oleg"},{value:"steven",label:"Steven"},{value:"clementine",label:"Clementine"},{value:"victoria",label:"Victoria"},{value:"joanna",label:"Joanna"},{value:"ivana",label:"Ivana"},{value:"ines",label:"Ines"},{value:"leticia",label:"Leticia"},{value:"marek",label:"Marek"},{value:"matthieu",label:"Matthieu"},{value:"info",label:"Info"},{value:"darcy",label:"Darcy"},{value:"bruno",label:"Bruno"},{value:"jennifer",label:"Jennifer"}]} form={form} set={set}/>
            </Grid>
